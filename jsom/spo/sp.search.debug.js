...
Microsoft.SharePoint.Client.Search.Query.QuerySuggestionResults.prototype = {
    ...
    initPropertiesFromJson: function Microsoft_SharePoint_Client_Search_Query_QuerySuggestionResults$initPropertiesFromJson(parentNode) {
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$X_1 = (([]));
            SP.DataConvert.populateArray(null, ((this.$X_1)), ($v_0));
            delete parentNode.PersonalResults;
        }
        $v_0 = parentNode.PopularResults;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$Y_1 = (([]));
            SP.DataConvert.populateArray(null, ((this.$Y_1)), ($v_0));
...
Microsoft.SharePoint.Client.Search.Query.ResultTableCollection.prototype = {
    ...
    initPropertiesFromJson: function Microsoft_SharePoint_Client_Search_Query_ResultTableCollection$initPropertiesFromJson(parentNode) {
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1p_2 = ((SP.DataConvert.fixupType(null, $v_0)));
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$22_2 = ((SP.DataConvert.fixupType(null, $v_0)));
...
Microsoft.SharePoint.Client.Search.Query.SearchExecutor.prototype = {
    ...
    getReportInfo: function Microsoft_SharePoint_Client_Search_Query_SearchExecutor$getReportInfo(tenantIdStr, reportType, interval, startDate, endDate, siteCollectionId) {
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'GetReportInfo', [ tenantIdStr, reportType, interval, startDate, endDate, siteCollectionId ]);
        $v_0.addQuery($v_2);
        $v_1 = new SP.JsonObjectResult();
        $v_0.addQueryIdAndResultObject($v_2.get_id(), $v_1);
        return $v_1;
    ...
    getQueryConfiguration: function Microsoft_SharePoint_Client_Search_Query_SearchExecutor$getQueryConfiguration(callLocalSearchFarmsOnly, skipGroupObjectIds, throwOnRemoteApiCheck) {
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'GetQueryConfiguration', [ callLocalSearchFarmsOnly, skipGroupObjectIds, throwOnRemoteApiCheck ]);
        $v_0.addQuery($v_2);
        $v_1 = new SP.JsonObjectResult();
        $v_0.addQueryIdAndResultObject($v_2.get_id(), $v_1);
        return $v_1;
...
Microsoft.SharePoint.Client.Search.Query.TenantCustomQuerySuggestions.prototype = {
    ...
    initPropertiesFromJson: function Microsoft_SharePoint_Client_Search_Query_TenantCustomQuerySuggestions$initPropertiesFromJson(parentNode) {
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$W_1 = (([]));
            SP.DataConvert.populateArray(null, ((this.$W_1)), ($v_0));
...
Microsoft.Office.Server.Search.REST.PromotedResultQueryRule.prototype = {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_PromotedResultQueryRule$initPropertiesFromJson(parentNode) {
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$Z_1 = (([]));
            SP.DataConvert.populateArray(null, ((this.$Z_1)), ($v_0));
...
Microsoft.Office.Server.Search.REST.QueryCondition.prototype = {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_QueryCondition$initPropertiesFromJson(parentNode) {
        ...
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1b_1 = ((SP.DataConvert.fixupType(null, $v_0)));
...
Microsoft.Office.Server.Search.REST.ReportAbandonedQueries = function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries() {
    Microsoft.Office.Server.Search.REST.ReportAbandonedQueries.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportAbandonedQueries.prototype = {
    $1_2: null,
    
    get_reports: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries$get_reports() {
        return this.$1_2;
    },
    
    set_reports: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries$set_reports(value) {
        this.$1_2 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries$get_typeId() {
        return '{667b7d60-0aa5-4044-b7a7-9be8aae8f3ef}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'Reports' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueries$initPropertiesFromJson(parentNode) {
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Reports;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1_2 = (([]));
            SP.DataConvert.populateArray(null, ((this.$1_2)), ($v_0));
            delete parentNode.Reports;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesData = function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData() {
    Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesData.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesData.prototype = {
    $c_1: 0,
    $3_1: null,
    $4_1: null,
    $7_1: 0,
    
    get_abandonedPercentage: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$get_abandonedPercentage() {
        return this.$c_1;
    },
    
    set_abandonedPercentage: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$set_abandonedPercentage(value) {
        this.$c_1 = value;
        return value;
    },
    
    get_queryText: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$get_queryText() {
        return this.$3_1;
    },
    
    set_queryText: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$set_queryText(value) {
        this.$3_1 = value;
        return value;
    },
    
    get_resultSource: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$get_resultSource() {
        return this.$4_1;
    },
    
    set_resultSource: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$set_resultSource(value) {
        this.$4_1 = value;
        return value;
    },
    
    get_total: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$get_total() {
        return this.$7_1;
    },
    
    set_total: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$set_total(value) {
        this.$7_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$get_typeId() {
        return '{e7cf7d0d-26fb-435c-ac16-1615c2236253}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'AbandonedPercentage', 'QueryText', 'ResultSource', 'Total' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        SP.ClientValueObject.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesData$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.AbandonedPercentage;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$c_1 = ($v_0);
            delete parentNode.AbandonedPercentage;
        }
        $v_0 = parentNode.QueryText;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$3_1 = ($v_0);
        ...
        $v_0 = parentNode.ResultSource;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$4_1 = ($v_0);
            delete parentNode.ResultSource;
        }
        $v_0 = parentNode.Total;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$7_1 = ($v_0);
            delete parentNode.Total;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesItem = function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem() {
    Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesItem.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesItem.prototype = {
    $2_1: null,
    $0_1: null,
    
    get_date: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$get_date() {
        return this.$2_1;
    },
    
    set_date: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$set_date(value) {
        this.$2_1 = value;
        return value;
    },
    
    get_report: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$get_report() {
        return this.$0_1;
    },
    
    set_report: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$set_report(value) {
        this.$0_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$get_typeId() {
        return '{7c167a9e-1949-41a4-a38c-b2cc5f3d4770}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportAbandonedQueriesItem$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Date;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$2_1 = ($v_0);
            delete parentNode.Date;
        }
        $v_0 = parentNode.Report;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$0_1 = (([]));
            SP.DataConvert.populateArray(null, ((this.$0_1)), ($v_0));
            delete parentNode.Report;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportBase = function Microsoft_Office_Server_Search_REST_ReportBase() {
    Microsoft.Office.Server.Search.REST.ReportBase.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportBase.prototype = {
    $s_1: null,
    
    get_farmId: function Microsoft_Office_Server_Search_REST_ReportBase$get_farmId() {
        return this.$s_1;
    },
    
    set_farmId: function Microsoft_Office_Server_Search_REST_ReportBase$set_farmId(value) {
        this.$s_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportBase$get_typeId() {
        return '{b748f908-3810-47ac-b0f9-df4072ce981b}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportBase$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportBase$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.FarmId;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$s_1 = ($v_0);
            delete parentNode.FarmId;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportNoResultData = function Microsoft_Office_Server_Search_REST_ReportNoResultData() {
    Microsoft.Office.Server.Search.REST.ReportNoResultData.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNoResultData.prototype = {
    $17_1: 0,
    $3_1: null,
    $4_1: null,
    $7_1: 0,
    
    get_noResultPercentage: function Microsoft_Office_Server_Search_REST_ReportNoResultData$get_noResultPercentage() {
        return this.$17_1;
    },
    
    set_noResultPercentage: function Microsoft_Office_Server_Search_REST_ReportNoResultData$set_noResultPercentage(value) {
        this.$17_1 = value;
        return value;
    },
    
    get_queryText: function Microsoft_Office_Server_Search_REST_ReportNoResultData$get_queryText() {
        return this.$3_1;
    },
    
    set_queryText: function Microsoft_Office_Server_Search_REST_ReportNoResultData$set_queryText(value) {
        this.$3_1 = value;
        return value;
    },
    
    get_resultSource: function Microsoft_Office_Server_Search_REST_ReportNoResultData$get_resultSource() {
        return this.$4_1;
    },
    
    set_resultSource: function Microsoft_Office_Server_Search_REST_ReportNoResultData$set_resultSource(value) {
        this.$4_1 = value;
        return value;
    },
    
    get_total: function Microsoft_Office_Server_Search_REST_ReportNoResultData$get_total() {
        return this.$7_1;
    },
    
    set_total: function Microsoft_Office_Server_Search_REST_ReportNoResultData$set_total(value) {
        this.$7_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNoResultData$get_typeId() {
        return '{ffcc09fa-c26f-49f3-98ae-8cd7c53783da}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNoResultData$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'NoResultPercentage', 'QueryText', 'ResultSource', 'Total' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        SP.ClientValueObject.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNoResultData$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.NoResultPercentage;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$17_1 = ($v_0);
            delete parentNode.NoResultPercentage;
        }
        $v_0 = parentNode.QueryText;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$3_1 = ($v_0);
...
Microsoft.Office.Server.Search.REST.ReportNoResultItem = function Microsoft_Office_Server_Search_REST_ReportNoResultItem() {
    Microsoft.Office.Server.Search.REST.ReportNoResultItem.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNoResultItem.prototype = {
    $2_1: null,
    $0_1: null,
    
    get_date: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$get_date() {
        return this.$2_1;
    },
    
    set_date: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$set_date(value) {
        this.$2_1 = value;
        return value;
    },
    
    get_report: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$get_report() {
        return this.$0_1;
    },
    
    set_report: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$set_report(value) {
        this.$0_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$get_typeId() {
        return '{3a99e1ce-c071-4015-8734-9daf509e9481}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNoResultItem$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Date;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportNoResultQueries = function Microsoft_Office_Server_Search_REST_ReportNoResultQueries() {
    Microsoft.Office.Server.Search.REST.ReportNoResultQueries.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNoResultQueries.prototype = {
    $1_2: null,
    
    get_reports: function Microsoft_Office_Server_Search_REST_ReportNoResultQueries$get_reports() {
        return this.$1_2;
    },
    
    set_reports: function Microsoft_Office_Server_Search_REST_ReportNoResultQueries$set_reports(value) {
        this.$1_2 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNoResultQueries$get_typeId() {
        return '{f9eb8c6f-641b-4f7f-a600-bb3f28fd620b}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNoResultQueries$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNoResultQueries$initPropertiesFromJson(parentNode) {
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Reports;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportNumberOfQueries = function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries() {
    Microsoft.Office.Server.Search.REST.ReportNumberOfQueries.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNumberOfQueries.prototype = {
    $1_2: null,
    
    get_reports: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries$get_reports() {
        return this.$1_2;
    },
    
    set_reports: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries$set_reports(value) {
        this.$1_2 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries$get_typeId() {
        return '{dcacf5da-5571-4152-8032-6cd885024f4e}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueries$initPropertiesFromJson(parentNode) {
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Reports;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesData = function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData() {
    Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesData.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesData.prototype = {
    $x_1: null,
    $4_1: null,
    $1d_1: null,
    
    get_hits: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$get_hits() {
        return this.$x_1;
    },
    
    set_hits: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$set_hits(value) {
        this.$x_1 = value;
        return value;
    },
    
    get_resultSource: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$get_resultSource() {
        return this.$4_1;
    },
    
    set_resultSource: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$set_resultSource(value) {
        this.$4_1 = value;
        return value;
    },
    
    get_totalQueries: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$get_totalQueries() {
        return this.$1d_1;
    },
    
    set_totalQueries: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$set_totalQueries(value) {
        this.$1d_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$get_typeId() {
        return '{7ed47ebb-e036-4c32-8e51-f0eb3af8e524}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'Hits', 'ResultSource', 'TotalQueries' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        SP.ClientValueObject.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesData$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Hits;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
        ...
        $v_0 = parentNode.TotalQueries;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1d_1 = ($v_0);
            delete parentNode.TotalQueries;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesItem = function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem() {
    Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesItem.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesItem.prototype = {
    $2_1: null,
    $0_1: null,
    
    get_date: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$get_date() {
        return this.$2_1;
    },
    
    set_date: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$set_date(value) {
        this.$2_1 = value;
        return value;
    },
    
    get_report: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$get_report() {
        return this.$0_1;
    },
    
    set_report: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$set_report(value) {
        this.$0_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$get_typeId() {
        return '{eed4767e-cc89-42ad-af7b-407bb5868761}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportNumberOfQueriesItem$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Date;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportQueryRules = function Microsoft_Office_Server_Search_REST_ReportQueryRules() {
    Microsoft.Office.Server.Search.REST.ReportQueryRules.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportQueryRules.prototype = {
    $1_2: null,
    
    get_reports: function Microsoft_Office_Server_Search_REST_ReportQueryRules$get_reports() {
        return this.$1_2;
    },
    
    set_reports: function Microsoft_Office_Server_Search_REST_ReportQueryRules$set_reports(value) {
        this.$1_2 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportQueryRules$get_typeId() {
        return '{88ed097b-8a1c-49b0-b20d-301ef9e0cff7}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportQueryRules$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportQueryRules$initPropertiesFromJson(parentNode) {
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Reports;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportQueryRulesData = function Microsoft_Office_Server_Search_REST_ReportQueryRulesData() {
    Microsoft.Office.Server.Search.REST.ReportQueryRulesData.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportQueryRulesData.prototype = {
    $n_1: null,
    $18_1: null,
    $1A_1: null,
    $1C_1: null,
    ...
    get_dictionaryTerms: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_dictionaryTerms() {
        return this.$n_1;
    },
    
    set_dictionaryTerms: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_dictionaryTerms(value) {
        this.$n_1 = value;
        return value;
    },
    
    get_ownerType: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_ownerType() {
        return this.$18_1;
    },
    
    set_ownerType: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_ownerType(value) {
        this.$18_1 = value;
        return value;
    },
    
    get_percentagePromotedResult: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_percentagePromotedResult() {
        return this.$1A_1;
    },
    
    set_percentagePromotedResult: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_percentagePromotedResult(value) {
        this.$1A_1 = value;
        return value;
    },
    
    get_promotedResultClicks: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_promotedResultClicks() {
        return this.$1C_1;
    },
    
    set_promotedResultClicks: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_promotedResultClicks(value) {
        this.$1C_1 = value;
        return value;
    },
    
    get_promotedResultId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_promotedResultId() {
        return this.$1D_1;
    },
    
    set_promotedResultId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_promotedResultId(value) {
        this.$1D_1 = value;
        return value;
    },
    
    get_promotedResultURL: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_promotedResultURL() {
        return this.$1E_1;
    },
    
    set_promotedResultURL: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_promotedResultURL(value) {
        this.$1E_1 = value;
        return value;
    },
    
    get_promotedResultURLName: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_promotedResultURLName() {
        return this.$1F_1;
    },
    
    set_promotedResultURLName: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_promotedResultURLName(value) {
        this.$1F_1 = value;
        return value;
    },
    
    get_queryRule: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_queryRule() {
        return this.$1N_1;
    },
    
    set_queryRule: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_queryRule(value) {
        this.$1N_1 = value;
        return value;
    },
    
    get_queryRuleId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_queryRuleId() {
        return this.$O_1;
    },
    
    set_queryRuleId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_queryRuleId(value) {
        this.$O_1 = value;
        return value;
    },
    
    get_resultSource: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_resultSource() {
        return this.$4_1;
    },
    
    set_resultSource: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_resultSource(value) {
        this.$4_1 = value;
        return value;
    },
    
    get_timesFired: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_timesFired() {
        return this.$1c_1;
    },
    
    set_timesFired: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$set_timesFired(value) {
        this.$1c_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$get_typeId() {
        return '{928cd874-bb85-48ee-9f4e-6c28963bf37b}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'DictionaryTerms', 'OwnerType', 'PercentagePromotedResult', 'PromotedResultClicks', 'PromotedResultId', 'PromotedResultURL', 'PromotedResultURLName', 'QueryRule', 'QueryRuleId', 'ResultSource', 'TimesFired' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        SP.ClientValueObject.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportQueryRulesData$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.DictionaryTerms;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$n_1 = ($v_0);
            delete parentNode.DictionaryTerms;
        }
        $v_0 = parentNode.OwnerType;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$18_1 = ($v_0);
            delete parentNode.OwnerType;
        }
        $v_0 = parentNode.PercentagePromotedResult;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1A_1 = ($v_0);
            delete parentNode.PercentagePromotedResult;
        }
        $v_0 = parentNode.PromotedResultClicks;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1C_1 = ($v_0);
            delete parentNode.PromotedResultClicks;
        }
        $v_0 = parentNode.PromotedResultId;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1D_1 = ($v_0);
            delete parentNode.PromotedResultId;
        }
        $v_0 = parentNode.PromotedResultURL;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1E_1 = ($v_0);
            delete parentNode.PromotedResultURL;
        }
        $v_0 = parentNode.PromotedResultURLName;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1F_1 = ($v_0);
            delete parentNode.PromotedResultURLName;
        }
        $v_0 = parentNode.QueryRule;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1N_1 = ($v_0);
            delete parentNode.QueryRule;
        }
        $v_0 = parentNode.QueryRuleId;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$O_1 = ($v_0);
        ...
        $v_0 = parentNode.TimesFired;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1c_1 = ($v_0);
            delete parentNode.TimesFired;
        }
    }
}


Microsoft.Office.Server.Search.REST.ReportQueryRulesItem = function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem() {
    Microsoft.Office.Server.Search.REST.ReportQueryRulesItem.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportQueryRulesItem.prototype = {
    $2_1: null,
    $0_1: null,
    
    get_date: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$get_date() {
        return this.$2_1;
    },
    
    set_date: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$set_date(value) {
        this.$2_1 = value;
        return value;
    },
    
    get_report: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$get_report() {
        return this.$0_1;
    },
    
    set_report: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$set_report(value) {
        this.$0_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$get_typeId() {
        return '{e78b90ec-79e8-4ac8-957d-cdbc8fb4cbe7}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportQueryRulesItem$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Date;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportTopQueries = function Microsoft_Office_Server_Search_REST_ReportTopQueries() {
    Microsoft.Office.Server.Search.REST.ReportTopQueries.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportTopQueries.prototype = {
    $1_2: null,
    
    get_reports: function Microsoft_Office_Server_Search_REST_ReportTopQueries$get_reports() {
        return this.$1_2;
    },
    
    set_reports: function Microsoft_Office_Server_Search_REST_ReportTopQueries$set_reports(value) {
        this.$1_2 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportTopQueries$get_typeId() {
        return '{66da651a-d0de-40ad-94bf-16697cee6a18}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportTopQueries$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportTopQueries$initPropertiesFromJson(parentNode) {
        Microsoft.Office.Server.Search.REST.ReportBase.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Reports;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.Office.Server.Search.REST.ReportTopQueriesData = function Microsoft_Office_Server_Search_REST_ReportTopQueriesData() {
    Microsoft.Office.Server.Search.REST.ReportTopQueriesData.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportTopQueriesData.prototype = {
    $1L_1: 0,
    $3_1: null,
    $4_1: null,
    $7_1: 0,
    
    get_queryPercentage: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$get_queryPercentage() {
        return this.$1L_1;
    },
    
    set_queryPercentage: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$set_queryPercentage(value) {
        this.$1L_1 = value;
        return value;
    },
    
    get_queryText: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$get_queryText() {
        return this.$3_1;
    },
    
    set_queryText: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$set_queryText(value) {
        this.$3_1 = value;
        return value;
    },
    
    get_resultSource: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$get_resultSource() {
        return this.$4_1;
    },
    
    set_resultSource: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$set_resultSource(value) {
        this.$4_1 = value;
        return value;
    },
    
    get_total: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$get_total() {
        return this.$7_1;
    },
    
    set_total: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$set_total(value) {
        this.$7_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$get_typeId() {
        return '{0835ad91-3750-4a37-962c-73aba95676fe}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
        ...
        var $v_0 = [ 'QueryPercentage', 'QueryText', 'ResultSource', 'Total' ];
        SP.DataConvert.writePropertiesToXml(writer, this, $v_0, serializationContext);
        SP.ClientValueObject.prototype.writeToXml.call(this, writer, serializationContext);
    },
    
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportTopQueriesData$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.QueryPercentage;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$1L_1 = ($v_0);
            delete parentNode.QueryPercentage;
        }
        $v_0 = parentNode.QueryText;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.$3_1 = ($v_0);
...
Microsoft.Office.Server.Search.REST.ReportTopQueriesItem = function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem() {
    Microsoft.Office.Server.Search.REST.ReportTopQueriesItem.initializeBase(this);
}
Microsoft.Office.Server.Search.REST.ReportTopQueriesItem.prototype = {
    $2_1: null,
    $0_1: null,
    
    get_date: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$get_date() {
        return this.$2_1;
    },
    
    set_date: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$set_date(value) {
        this.$2_1 = value;
        return value;
    },
    
    get_report: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$get_report() {
        return this.$0_1;
    },
    
    set_report: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$set_report(value) {
        this.$0_1 = value;
        return value;
    },
    
    get_typeId: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$get_typeId() {
        return '{b6066b6e-5e96-4db8-a321-cb31d48e0e08}';
    },
    
    writeToXml: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$writeToXml(writer, serializationContext) {
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function Microsoft_Office_Server_Search_REST_ReportTopQueriesItem$initPropertiesFromJson(parentNode) {
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Date;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
Microsoft.SharePoint.Client.Search.ContentPush.PushTenantManager.prototype = {
    ...
    lookupInSpoDs: function Microsoft_SharePoint_Client_Search_ContentPush_PushTenantManager$lookupInSpoDs(keys, keyProperty, selectProperties) {
        var $v_0 = this.get_context();
        var $v_1;
        $v_1 = new Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult($v_0, new SP.ObjectPathMethod($v_0, this.get_path(), 'LookupInSpoDs', [ keys, keyProperty, selectProperties ]));
        return $v_1;
    }
}
...
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties = function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2Properties(context, objectPath) {
    Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties.initializeBase(this, [ context, objectPath ]);
}
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties.prototype = {
    
    get_properties: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2Properties$get_properties() {
        this.checkUninitializedProperty('Properties');
        return ((this.get_objectData().get_properties()['Properties']));
    },
    
    initPropertiesFromJson: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2Properties$initPropertiesFromJson(parentNode) {
        SP.ClientObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Properties;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
    ...
    getProperty: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2Properties$getProperty(name) {
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'GetProperty', [ name ]);
        $v_0.addQuery($v_2);
        $v_1 = new SP.StringResult();
        $v_0.addQueryIdAndResultObject($v_2.get_id(), $v_1);
        return $v_1;
...
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2PropertiesPropertyNames = function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2PropertiesPropertyNames() {
}


Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult = function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2SearchResult(context, objectPath) {
    Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult.initializeBase(this, [ context, objectPath ]);
}
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult.prototype = {
    
    itemAt: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2SearchResult$itemAt(index) {
        return this.getItemAtIndex(index);
    },
    
    get_item: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2SearchResult$get_item(index) {
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function Microsoft_SharePoint_Client_Search_ContentPush_SpoDs2SearchResult$get_childItemType() {
        return Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties;
    }
}
...
Microsoft.Office.Server.Search.REST.ReportBase.registerClass('Microsoft.Office.Server.Search.REST.ReportBase', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportAbandonedQueries.registerClass('Microsoft.Office.Server.Search.REST.ReportAbandonedQueries', Microsoft.Office.Server.Search.REST.ReportBase);
Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesData.registerClass('Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesData', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesItem.registerClass('Microsoft.Office.Server.Search.REST.ReportAbandonedQueriesItem', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportNoResultData.registerClass('Microsoft.Office.Server.Search.REST.ReportNoResultData', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportNoResultItem.registerClass('Microsoft.Office.Server.Search.REST.ReportNoResultItem', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportNoResultQueries.registerClass('Microsoft.Office.Server.Search.REST.ReportNoResultQueries', Microsoft.Office.Server.Search.REST.ReportBase);
Microsoft.Office.Server.Search.REST.ReportNumberOfQueries.registerClass('Microsoft.Office.Server.Search.REST.ReportNumberOfQueries', Microsoft.Office.Server.Search.REST.ReportBase);
Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesData.registerClass('Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesData', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesItem.registerClass('Microsoft.Office.Server.Search.REST.ReportNumberOfQueriesItem', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportQueryRules.registerClass('Microsoft.Office.Server.Search.REST.ReportQueryRules', Microsoft.Office.Server.Search.REST.ReportBase);
Microsoft.Office.Server.Search.REST.ReportQueryRulesData.registerClass('Microsoft.Office.Server.Search.REST.ReportQueryRulesData', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportQueryRulesItem.registerClass('Microsoft.Office.Server.Search.REST.ReportQueryRulesItem', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportTopQueries.registerClass('Microsoft.Office.Server.Search.REST.ReportTopQueries', Microsoft.Office.Server.Search.REST.ReportBase);
Microsoft.Office.Server.Search.REST.ReportTopQueriesData.registerClass('Microsoft.Office.Server.Search.REST.ReportTopQueriesData', SP.ClientValueObject);
Microsoft.Office.Server.Search.REST.ReportTopQueriesItem.registerClass('Microsoft.Office.Server.Search.REST.ReportTopQueriesItem', SP.ClientValueObject);
...
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties.registerClass('Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2Properties', SP.ClientObject);
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2PropertiesPropertyNames.registerClass('Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2PropertiesPropertyNames');
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult.registerClass('Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2SearchResult', SP.ClientObjectCollection);
...
Microsoft.SharePoint.Client.Search.Query.QueryUtility.$24 = [ null, String, Number, Boolean, Array ];
...
Microsoft.SharePoint.Client.Search.ContentPush.SpoDs2PropertiesPropertyNames.properties = 'Properties';
