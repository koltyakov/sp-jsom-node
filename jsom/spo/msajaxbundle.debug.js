...
Sys.Res={"appDuplicateComponent":"Two components with the same id \u0027{0}\u0027 can\u0027t be added to the application.","componentCantSetIdTwice":"The id property of a component can\u0027t be set more than once.","elementNotFound":"An element with id \u0027{0}\u0027 could not be found.","referenceNotFound":"Component \u0027{0}\u0027 was not found.","eventHandlerNotFunction":"Handler must be a function.","historyCannotAddHistoryPointWithHistoryDisabled":"A history point can only be added if enableHistory is set to true.","scriptLoadFailedDebug":"The script \u0027{0}\u0027 failed to load. Check for:\r\n Inaccessible path.\r\n Script errors. (IE) Enable \u0027Display a notification about every script error\u0027 under advanced settings.","notAnInterface":"Value is not a valid interface.","historyCannotEnableHistory":"Cannot set enableHistory after initialization.","observableConflict":"Object already contains a member with the name \u0027{0}\u0027.","undefinedEvent":"\u0027{0}\u0027 is not an event.","eventHandlerInvalid":"Handler was not added through the Sys.UI.DomEvent.addHandler method.","notATypeName":"Value is not a valid type name.","stateFieldNameInvalid":"State field names must not contain any \u0027=\u0027 characters.","circularParentChain":"The chain of control parents can\u0027t have circular references.","propertyNotAnArray":"\u0027{0}\u0027 is not an Array property.","enumInvalidValueName":"\u0027{0}\u0027 is not a valid name for an enum value.","baseNotAClass":"Value is not a class.","invalidNameSpace":"Value is not a valid namespace identifier.","historyMissingFrame":"For the history feature to work in IE, the page must have an iFrame element with id \u0027__historyFrame\u0027 pointed to a page that gets its title from the \u0027title\u0027 query string parameter and calls Sys.Application._onIFrameLoad() on the parent window. This can be done by setting EnableHistory to true on ScriptManager.","stateMustBeStringDictionary":"The state object can only have null and string fields.","createNoDom":"Value must not be null for Controls and Behaviors.","cantBeCalledAfterDispose":"Can\u0027t be called after dispose.","expectedElementOrId":"Value must be a DOM element or DOM element Id.","badTypeName":"Value is not the name of the type being registered or the name is a reserved word.","createNotComponent":"{0} does not derive from Sys.Component.","behaviorDuplicateName":"A behavior with name \u0027{0}\u0027 already exists or it is the name of an existing property on the target element.","stringFormatBraceMismatch":"The format string contains an unmatched opening or closing brace.","cantAddWithoutId":"Can\u0027t add a component that doesn\u0027t have an id.","addHandlerCantBeUsedForError":"Can\u0027t add a handler for the error event using this method. Please set the window.onerror property instead.","stringFormatInvalid":"The format string is invalid.","enumReservedName":"\u0027{0}\u0027 is a reserved name that can\u0027t be used as an enum value name.","propertyNullOrUndefined":"Cannot set the properties of \u0027{0}\u0027 because it returned a null value.","boolTrueOrFalse":"Value must be \u0027true\u0027 or \u0027false\u0027.","createComponentOnDom":"Value must be null for Components that are not Controls or Behaviors.","methodNotFound":"No method found with name \u0027{0}\u0027.","propertyNotWritable":"\u0027{0}\u0027 is not a writable property.","notObservable":"Instances of type \u0027{0}\u0027 cannot be observed.","cantSetId":"The id property can\u0027t be set on this object.","namespaceContainsNonObject":"Object {0} already exists and is not an object.","componentCantSetIdAfterAddedToApp":"The id property of a component can\u0027t be set after it\u0027s been added to the Application object.","typeRegisteredTwice":"Type {0} has already been registered. The type may be defined multiple times or the script file that defines it may have already been loaded. A possible cause is a change of settings during a partial update.","namespaceContainsClass":"Object {0} already exists as a class, enum, or interface.","controlAlreadyDefined":"A control is already associated with the element.","cantAddNonFunctionhandler":"Can\u0027t add a handler that is not a function.","argumentTypeName":"Value is not the name of an existing type.","scriptLoadFailedNoHead":"ScriptLoader requires pages to contain a \u003chead\u003e element.","urlTooLong":"The history state must be small enough to not make the url larger than {0} characters.","argumentDomNode":"Value must be a DOM element or a text node.","arrayParseBadFormat":"Value must be a valid string representation for an array. It must start with a \u0027[\u0027 and end with a \u0027]\u0027.","propertyUndefined":"\u0027{0}\u0027 is not a property or an existing field.","cantSetNameAfterInit":"The name property can\u0027t be set on this object after initialization.","enumValueNotInteger":"An enumeration definition can only contain integer values."};
//-----------------------------------------------------------------------
// Copyright (C) Microsoft Corporation. All rights reserved.
//-----------------------------------------------------------------------
