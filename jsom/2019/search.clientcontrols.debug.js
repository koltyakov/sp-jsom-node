...
Srch.ClientControl.$3U = function Srch_ClientControl$$3U$st($p0) {
...
Srch.ClientControl.prototype = {
    ...
    set_messages: function Srch_ClientControl$set_messages$in(value) {
        if (!Srch.U.n(value) && value.length > 0) {
            ...
            for (var $v_0 = 0; $v_0 < value.length; $v_0++) {
                var $v_1 = value[$v_0];
                if (!Srch.U.n($v_1)) {
                    Srch.U.appendArray(this.$8_2, Srch.ControlMessage.getIfControlMessage($v_1));
                }
            }
        }
        else {
    ...
    initialize: function Srch_ClientControl$initialize$in() {
        ...
        this.$1J_2 = this.$$d_scriptApplication_PreLoad;
        Srch.ScriptApplicationManager.get_current().add_preLoad(this.$1J_2);
        this.$1A_2 = this.$$d_scriptApplication_Load;
        Srch.ScriptApplicationManager.get_current().add_load(this.$1A_2);
        this.$1I_2 = this.$$d_scriptApplication_PostLoad;
        Srch.ScriptApplicationManager.get_current().add_postLoad(this.$1I_2);
    ...
    $5R_2: function Srch_ClientControl$$5R_2$in() {
    ...
    dispose: function Srch_ClientControl$dispose$in() {
        ...
        try {
            ...
            if (!Srch.U.n(this.$1J_2)) {
                Srch.ScriptApplicationManager.get_current().remove_preLoad(this.$1J_2);
                this.$1J_2 = null;
            }
            if (!Srch.U.n(this.$1A_2)) {
                Srch.ScriptApplicationManager.get_current().remove_load(this.$1A_2);
                this.$1A_2 = null;
            }
            if (!Srch.U.n(this.$1I_2)) {
                Srch.ScriptApplicationManager.get_current().remove_postLoad(this.$1I_2);
                this.$1I_2 = null;
            }
        }
        finally {
    ...
    processDataProviderErrors: function Srch_ClientControl$processDataProviderErrors$in(dataProviderToProcess) {
        if (!Srch.U.n(dataProviderToProcess) && !Srch.U.n(dataProviderToProcess.$8_2) && dataProviderToProcess.$8_2.length > 0) {
            this.processDataErrorMessages(dataProviderToProcess.$8_2);
        }
    },
    ...
    scriptApplication_PreLoad: function Srch_ClientControl$scriptApplication_PreLoad$in(sender, e) {
        ...
        if (this.$12_2) {
            Srch.U.appendScriptsToLoad(this.serverTemplateScriptsToLoad, this.$27_2);
        }
    },
    ...
    loadRenderTemplateScripts: function Srch_ClientControl$loadRenderTemplateScripts$in(scriptReferences, success, failure, timeout, loadStandAloneCustomScripts) {
        ...
        if (Srch.U.loadScripts(scriptReferences, function($p1_0) {
            $$t_7.$5x_2($p1_0, success, failure, timeout);
        }, function($p1_0) {
            $$t_8.$5w_2($p1_0, failure);
        }, timeout)) {
            return true;
        }
    ...
    $5x_2: function Srch_ClientControl$$5x_2$in($p0, $p1, $p2, $p3) {
    ...
    $5w_2: function Srch_ClientControl$$5w_2$in($p0, $p1) {
        this.$1_2('RenderTemplateScriptsFailed', 'Loading render template scripts faild.');
        this.$4Y_2($p0);
        $p1();
    },
    
    $4Q_2: function Srch_ClientControl$$4Q_2$in($p0, $p1, $p2) {
        this.$1_2('LoadCustomScripts', 'Loading custom scripts...');
        if (!Srch.U.n(Srch.ScriptApplicationManager.get_current().$1c_1)) {
            var $v_0 = [];
            var $$dict_7 = Srch.ScriptApplicationManager.get_current().$1c_1;
            for (var $$key_8 in $$dict_7) {
                ...
                if (!Srch.U.e($v_2)) {
                    ...
                    if ($v_3.endsWith('.css')) {
                        ...
                        if (Srch.U.n(Srch.ScriptApplicationManager.get_current().$1B_1[$v_3])) {
                            registerCssLink($v_3);
                            Srch.U.traceFormatted(null, 'LoadCustomScripts', 'Registering css \'{0}\' as loaded', $v_3);
                            Srch.ScriptApplicationManager.get_current().$1B_1[$v_3] = false;
                        }
                    }
                    else {
    ...
    $5E_2: function Srch_ClientControl$$5E_2$in($p0, $p1) {
        this.$1_2('CustomScriptsLoaded', 'All custom scripts loaded.');
        Srch.U.registerLoadedScripts($p0);
        $p1();
    },
    
    $5D_2: function Srch_ClientControl$$5D_2$in($p0, $p1) {
        ...
        Srch.U.appendArray(this.$8_2, $v_3);
        $p1();
    },
    
    $4Y_2: function Srch_ClientControl$$4Y_2$in($p0) {
        var $v_0 = '<ul>';
        if (!Srch.U.n($p0)) {
    ...
    $5I_2: function Srch_ClientControl$$5I_2$in() {
    ...
    processRenderingErrorMessages: function Srch_ClientControl$processRenderingErrorMessages$in(ctx) {
        ...
        if (!Srch.U.n($v_0) && Srch.U.isArray($v_0)) {
            for (var $$arr_2 = $v_0, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
                var $v_1 = $$arr_2[$$idx_4];
                Srch.U.appendArray(this.$1O_2, Srch.ControlMessage.getFromException($v_1));
            }
            ctx['Errors'] = null;
        }
    },
    ...
    hasMessages: function Srch_ClientControl$hasMessages$in() {
        var $v_0 = Srch.U.$3N();
        return (!!this.$8_2 && this.$8_2.length > 0) || (!!this.$e_2 && this.$e_2.length > 0) || (!!this.$1O_2 && this.$1O_2.length > 0) || (!!$v_0 && $v_0.length > 0);
    },
    ...
    $47_2: function Srch_ClientControl$$47_2$in($p0) {
        var $v_0 = this.$5K_2(this.$8_2, this.$e_2, this.$1O_2, Srch.U.$3N(), $p0);
        if (!Srch.U.w($v_0) || !$p0) {
    ...
    $5h_2: function Srch_ClientControl$$5h_2$in($p0) {
        return this.$3T_2($p0) || Srch.ClientControl.$3U($p0);
    },
    
    $3T_2: function Srch_ClientControl$$3T_2$in($p0) {
        return Srch.U.isPageInEditMode() || (!$p0.showInEditModeOnly && this.$61_2());
    },
    
    $61_2: function Srch_ClientControl$$61_2$in() {
    ...
    $5g_2: function Srch_ClientControl$$5g_2$in($p0) {
    ...
    $2l_2: function Srch_ClientControl$$2l_2$in($p0, $p1) {
        if (Srch.U.n(this.$8_2)) {
            return false;
        }
        var $v_0 = false;
    ...
    $5K_2: function Srch_ClientControl$$5K_2$in($p0, $p1, $p2, $p3, $p4) {
        this.$35_2 = {};
        if (!$p4) {
            this.$W_2 = [];
            this.$a_2 = [];
            ...
            this.$1y_2 = 0;
            this.$X_2 = '';
            this.$2l_2($p0, this.$W_2);
        }
        if (this.$30_2) {
            this.$2l_2($p1, this.$W_2);
        }
        var $v_0 = this.$2l_2($p2, this.$a_2);
        $v_0 = !!($v_0 | this.$2l_2($p3, this.$a_2));
        var $v_1 = new Sys.StringBuilder();
        if (!Srch.U.n(this.$17_2) && this.$17_2.length > 0) {
            $v_1.append('<div class=\"ms-status-msg ms-status-blue\">');
            this.$1r_2 = true;
            this.$3J_2($v_1, this.$17_2);
            $v_1.append('</div>');
        }
        if ((!Srch.U.n(this.$W_2) && this.$W_2.length > 0) || (!Srch.U.n(this.$a_2) && this.$a_2.length > 0)) {
            $v_1.append('<h2 class=\"ms-search-header, ms-srch-error-header\">' + SP.Utilities.HttpUtility.htmlEncode(this.$X_2) + '</h2>');
            if (this.$16_2) {
                ...
                this.$1r_2 = true;
                this.$3J_2($v_1, this.$W_2);
                if ($v_0) {
                    this.$5L_2($v_1);
                    this.$3J_2($v_1, this.$a_2);
                }
                $v_1.append('</div></div>');
            }
        }
    ...
    $5L_2: function Srch_ClientControl$$5L_2$in($p0) {
        this.$3H_2($p0);
        ...
        $p0.append(String.format(Srch.ClientControl.$1z, $v_0));
    },
    
    $3J_2: function Srch_ClientControl$$3J_2$in($p0, $p1) {
        for (var $$arr_2 = $p1, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
            ...
            if (this.$3T_2($v_0) && !Srch.U.w($v_0.messageDetails)) {
                ...
                this.$41_2($p0, String.format(Srch.ClientControl.$1z, $v_1));
            }
                ...
                this.$41_2($p0, String.format(Srch.ClientControl.$1z, $v_2));
            }
            this.$5J_2($p0, $v_0.correlationID);
        }
    },
    
    $5J_2: function Srch_ClientControl$$5J_2$in($p0, $p1) {
        if (!Srch.U.w($p1)) {
            this.$3H_2($p0);
            ...
            $p0.append(String.format(Srch.ClientControl.$1z, String.format($v_0, $p1)));
        }
    },
    
    $41_2: function Srch_ClientControl$$41_2$in($p0, $p1) {
        if (!this.$35_2[$p1]) {
            this.$35_2[$p1] = true;
            this.$3H_2($p0);
            $p0.append($p1);
    ...
    $3H_2: function Srch_ClientControl$$3H_2$in($p0) {
        if (this.$1r_2) {
            this.$1r_2 = false;
        }
        else {
...
Srch.DataProvider = function Srch_DataProvider(elem) {
    ...
    this.$18_3 = new Srch.QueryState();
    this.$1o_3 = -1;
    this.$1v_3 = -1;
    this.$2J_3 = -1;
    Srch.DataProvider.initializeBase(this, [ elem ]);
}
Srch.DataProvider.$4I = function Srch_DataProvider$$4I$st($p0, $p1) {
...
Srch.DataProvider.prototype = {
    ...
    get_$28_3: function Srch_DataProvider$get_$28_3$in() {
        return this.$3f_3.toString() + this.$5_3;
    },
    
    get_$4W_3: function Srch_DataProvider$get_$4W_3$in() {
        this.$3f_3 = SP.Guid.newGuid();
        return this.get_$28_3();
    },
    ...
    set_initialQueryState: function Srch_DataProvider$set_initialQueryState$in(value) {
        this.$18_3.copyFrom(value, 0);
        if (value.l <= 0) {
            this.$18_3.l = this.get_effectiveQueryLanguage();
        }
        return value;
    },
    ...
    set_fallbackRefinementFilters: function Srch_DataProvider$set_fallbackRefinementFilters$in(value) {
        this.$f_3 = Srch.U.$2S(value, Srch.RefinementCategory);
        return value;
    },
    ...
    get_clientFunction: function Srch_DataProvider$get_clientFunction$in() {
        return this.$2O_3;
    },
    
    set_clientFunction: function Srch_DataProvider$set_clientFunction$in(value) {
        this.$2O_3 = value;
        return value;
    },
    ...
    get_clientFunctionDetails: function Srch_DataProvider$get_clientFunctionDetails$in() {
        return this.$39_3;
    },
    
    set_clientFunctionDetails: function Srch_DataProvider$set_clientFunctionDetails$in(value) {
        this.$39_3 = value;
        return value;
    },
    ...
    get_queryDateTimeCulture: function Srch_DataProvider$get_queryDateTimeCulture$in() {
    ...
    get_$5G_3: function Srch_DataProvider$get_$5G_3$in() {
        var $v_0 = null;
        ...
        if (Srch.U.n($v_0) && !Srch.U.n(this.$1q_3)) {
            $v_0 = this.$1q_3;
    ...
    raiseQueryIssuingEvent: function Srch_DataProvider$raiseQueryIssuingEvent$in(arg) {
        ...
        this.$23_3++;
        LogRUMExtendedAction('SearchDataProviderIssueQuery', this.$23_3, null, new Date().getTime(), 0);
        this.$29_3 = false;
        this.set_messages([]);
    ...
    raiseResultReadyEvent: function Srch_DataProvider$raiseResultReadyEvent$in(arg) {
        ...
        LogRUMExtendedAction('SearchDataProviderRaiseResultReady', this.$23_3, $v_0, new Date().getTime(), 0);
        this.$2t_3 = arg;
        if (!Srch.U.n(arg)) {
        ...
        this.$4a_3(this.$2t_3);
        $v_1.stop();
        LogRUMExtendedAction('SearchDataProviderDoneRaisingResultReady', this.$23_3, $v_0, new Date().getTime(), 0);
    },
    
    $4a_3: function Srch_DataProvider$$4a_3$in($p0) {
    ...
    $5d_3: function Srch_DataProvider$$5d_3$in() {
        this.$1_2('LoadTemplateScripts', 'Trying to load template scripts...');
        return this.loadRenderTemplateScripts(this.$2H_3, this.$$d_$64_3, this.$$d_$64_3, -1, true);
    },
    
    $64_3: function Srch_DataProvider$$64_3$in() {
        this.$1_2('TemplateScriptsCallback', 'TemplateScriptsCallback');
        this.$2H_3 = [];
        this.$4a_3(this.$2t_3);
    },
    
    $4Z_3: function Srch_DataProvider$$4Z_3$in($p0) {
        ...
        if (!this.$R_3) {
            this.$1H_3 = Srch.U.getTableProperty($p0, 'piPageImpression');
        }
        var $v_1 = 0;
                ...
                if (!Srch.U.n($v_4)) {
                    if (Srch.U.isTableTypeof($v_4, Microsoft.SharePoint.Client.Search.Query.KnownTableTypes.refinementResults)) {
                        ...
                        if (this.$3R_3) {
                            ...
                            Srch.U.appendScriptsToLoad(this.$2H_3, $v_6);
                        }
                        if (this.$3S_3) {
                            ...
                            if (!Srch.U.n($v_7) && $v_7.length > 0) {
                                for (var $v_8 = 0; $v_8 < $v_7.length; $v_8++) {
                                    ...
                                    if (!Srch.U.n($v_9)) {
                                        ...
                                        Srch.U.appendScriptsToLoad(this.$2H_3, $v_A);
    ...
    $5p_3: function Srch_DataProvider$$5p_3$in($p0) {
        if (!Srch.U.n($p0)) {
                    ...
                    if (!Srch.U.n($v_5)) {
                        ...
                        if (!Srch.U.e($v_6)) {
                            ...
                            if (Srch.ValueInfo.isKnownEntityPropertyName($v_6)) {
                                this.$5f_3($v_5, $v_6, $v_3);
                            }
                            else {
                                var $v_7 = this.$5n_3($v_5, $v_6, $v_2);
    ...
    $5r_3: function Srch_DataProvider$$5r_3$in($p0) {
    ...
    $5n_3: function Srch_DataProvider$$5n_3$in($p0, $p1, $p2) {
        ...
        if ($v_0 === 'Boolean' || 'OWSBOOL' === $v_1) {
            ...
            return this.$5o_3($p0, $p1, $p2);
        }
    },
    
    $5o_3: function Srch_DataProvider$$5o_3$in($p0, $p1, $p2) {
        var $v_0 = $p0;
        var $v_1 = false;
        try {
    ...
    displayControl_QueryReady: function Srch_DataProvider$displayControl_QueryReady$in(sender, e) {
        ...
        if (!Srch.U.n($v_0)) {
            ...
            if (!Srch.U.n($v_1)) {
                this.$36_3($v_1, Srch.DataProvider.$4I($v_0, 2));
    ...
    searchBox_QueryReady: function Srch_DataProvider$searchBox_QueryReady$in(sender, e) {
        ...
        if (!Srch.U.n($v_0)) {
            ...
            var $v_1 = $v_0.queryState;
            if (!Srch.U.n($v_1)) {
                this.$36_3($v_1, Srch.DataProvider.$4I($v_0, 1));
    ...
    searchBox_BatchQueryIssuing: function Srch_DataProvider$searchBox_BatchQueryIssuing$in(sender, e) {
        ...
        if (this.$w_3) {
            ...
            if (!Srch.U.n($v_1) || $v_0.skipSearch) {
                ...
                this.$2n_3('SearchBox_BatchQueryIssuing', $v_0);
            }
        }
    },
    ...
    $5P_3: function Srch_DataProvider$$5P_3$in() {
        var $v_0 = null;
    ...
    $4y_3: function Srch_DataProvider$$4y_3$in($p0, $p1) {
        if (Srch.U.n($p0)) {
    ...
    processInitial: function Srch_DataProvider$processInitial$in() {
        ...
        if (this.$2_3.equalsTo(this.$18_3)) {
            this.$1_2('ProcessInitial', 'Already at initial state.');
            return;
        }
        this.$36_3(this.$18_3, 0);
    ...
    $36_3: function Srch_DataProvider$$36_3$in($p0, $p1) {
    ...
    $5X_3: function Srch_DataProvider$$5X_3$in() {
    ...
    $2n_3: function Srch_DataProvider$$2n_3$in($p0, $p1) {
        if ($p1.skipSearch) {
    ...
    $4v_3: function Srch_DataProvider$$4v_3$in($p0, $p1) {
    ...
    $4b_3: function Srch_DataProvider$$4b_3$in($p0) {
        this.$3_2('RaiseResultReadyEventIfNeeded', 'Looking for result with request ID \'{0}\' for query group \'{1}\'', this.get_$28_3(), this.$5_3);
        if (!Srch.U.n($p0)) {
            ...
            for (var $$key_9 in $$dict_8) {
                ...
                if (!Srch.U.w($v_1.key)) {
                    ...
                    if ($v_1.key === '__' || $v_1.key === this.get_$28_3()) {
                        var $v_2 = $v_1.value;
                        if (!Srch.U.n($v_2)) {
                            var $v_3 = $v_2['QueryErrors'];
                            if (!Srch.U.n($v_3)) {
                                this.$3_2('RaiseResultReadyEventIfNeeded', 'Looking for query error with key \'{0}\'', this.get_$28_3());
                                var $v_5 = Srch.ControlMessage.getIfControlMessage($v_3[this.get_$28_3()]);
                                if (Srch.U.n($v_5)) {
    ...
    $2m_3: function Srch_DataProvider$$2m_3$in($p0) {
        if (!this.$29_3) {
            Srch.U.appendArray(this.$8_2, $p0);
            this.raiseEmptyResultReadyEvent();
        }
    },
    ...
    getSortRankName: function Srch_DataProvider$getSortRankName$in() {
        if (!Srch.U.n(this.$2_3.m) && Srch.U.n(this.$2_3.o)) {
            if (this.$2_3.m === Srch.DataProvider.$20 || this.$2_3.m === Srch.DataProvider.$1n || this.$2_3.m === Srch.DataProvider.$2e) {
...
Srch.DisplayControl.prototype = {
    ...
    get_dataProvider: function Srch_DisplayControl$get_dataProvider$in() {
        if (Srch.U.n(this.$2R_3)) {
            var $v_0 = Srch.ScriptApplicationManager.get_current().queryGroups[this.$5_3];
            if (!Srch.U.n($v_0)) {
                this.$2R_3 = $v_0.dataProvider;
            }
        }
        return this.$2R_3;
    },
    ...
    scriptApplication_PreLoad: function Srch_DisplayControl$scriptApplication_PreLoad$in(sender, e) {
        ...
        else if (!Srch.U.n(this.$8_2) && this.$8_2.length > 0) {
            this.displayControlMessages();
        }
        Srch.ClientControl.prototype.scriptApplication_PreLoad.call(this, sender, e);
    },
    ...
    add_oneTimeResultRendered: function Srch_DisplayControl$add_oneTimeResultRendered$in(value) {
        ...
        Srch.U.appendArray(this.$1F_3, value);
    },
    ...
    raiseOneTimeResultRenderedEvent: function Srch_DisplayControl$raiseOneTimeResultRenderedEvent$in(arg) {
        ...
        if (!Srch.U.n(this.$1F_3)) {
            for (var $v_1 = 0; $v_1 < this.$1F_3.length; $v_1++) {
                var $v_2 = this.$1F_3[$v_1];
...
Srch.Refinement.$1t = function Srch_Refinement$$1t$st($p0, $p1) {
    if (!Srch.U.n($p0)) {
...
Srch.Refinement.$4G = function Srch_Refinement$$4G$st($p0, $p1, $p2, $p3) {
...
Srch.Refinement.prototype = {
    ...
    get_emptyRefinementMessageId: function Srch_Refinement$get_emptyRefinementMessageId$in() {
        if (Srch.U.e(this.$1g_4)) {
            this.$1g_4 = this.get_nextUniqueId() + 'EmptyRefinement';
        }
        return this.$1g_4;
    },
    ...
    $52_4: function Srch_Refinement$$52_4$in($p0, $p1) {
    },
    
    $5H_4: function Srch_Refinement$$5H_4$in() {
        if (Srch.U.n(this.alternateRenderer)) {
            var $v_0 = false;
    ...
    $5v_4: function Srch_Refinement$$5v_4$in($p0) {
    ...
    addRefinementFiltersWithOp: function Srch_Refinement$addRefinementFiltersWithOp$in(refiners, op) {
        ...
        for (var $$key_A in $$dict_9) {
            ...
            var $v_5 = Srch.Refinement.$1t($v_3, $v_0.r);
            if (!Srch.U.n($v_5)) {
                if (!Srch.U.n($v_4)) {
    ...
    $4z_4: function Srch_Refinement$$4z_4$in($p0, $p1, $p2, $p3, $p4) {
        var $$dict_9 = $p1;
        for (var $$key_A in $$dict_9) {
    ...
    hasRefinementFilter: function Srch_Refinement$hasRefinementFilter$in(filterName, filterToken) {
        if (!Srch.U.e(filterName) && !Srch.U.e(filterToken) && !Srch.U.n(this.get_dataProvider())) {
            var $v_0 = Srch.Refinement.$1t(filterName, this.get_dataProvider().$2_3.r);
            if (!Srch.U.n($v_0)) {
    ...
    hasRefinementCategory: function Srch_Refinement$hasRefinementCategory$in(refinementName) {
        if (!Srch.U.e(refinementName) && !Srch.U.n(this.get_dataProvider())) {
            var $v_0 = Srch.Refinement.$1t(refinementName, this.get_dataProvider().$2_3.r);
            if (!Srch.U.n($v_0)) {
                return true;
            }
            else {
    ...
    $3M_4: function Srch_Refinement$$3M_4$in($p0) {
        var $v_0 = [];
    ...
    processQueryIssuing: function Srch_Refinement$processQueryIssuing$in(qs) {
        ...
        if (!this.$2c_4 || this.get_dataProvider().$R_3 === 3) {
            return;
        }
        var $$dict_7 = this.$3Y_4;
        for (var $$key_8 in $$dict_7) {
...
Srch.Result = function Srch_Result(elem) {
    this.$$d_$5m_4 = Function.createDelegate(this, this.$5m_4);
...
Srch.Result.$4X = function Srch_Result$$4X$st($p0) {
    var $v_0 = {};
    if (!Srch.U.e($p0)) {
...
Srch.Result.prototype = {
    ...
    get_showXGeoOptions: function Srch_Result$get_showXGeoOptions$in() {
        return this.$3s_4;
    },
    
    set_showXGeoOptions: function Srch_Result$set_showXGeoOptions$in(value) {
        this.$3s_4 = value;
        return value;
    },
    ...
    get_isXGeoFlighted: function Srch_Result$get_isXGeoFlighted$in() {
        return this.$3Q_4;
    },
    
    set_isXGeoFlighted: function Srch_Result$set_isXGeoFlighted$in(value) {
        this.$3Q_4 = value;
        return value;
    },
    ...
    get_searchCenterXGeoLocations: function Srch_Result$get_searchCenterXGeoLocations$in() {
        return this.$3h_4;
    },
    
    set_searchCenterXGeoLocations: function Srch_Result$set_searchCenterXGeoLocations$in(value) {
        this.$3h_4 = value;
        return value;
    },
    ...
    get_xGeoTenantsInfo: function Srch_Result$get_xGeoTenantsInfo$in() {
        return this.$3w_4;
    },
    
    set_xGeoTenantsInfo: function Srch_Result$set_xGeoTenantsInfo$in(value) {
        this.$3w_4 = value;
        return value;
    },
    ...
    get_shouldShowNoResultMessage: function Srch_Result$get_shouldShowNoResultMessage$in() {
        if (!this.$2B_4 && !this.$2C_4 && !this.$2E_4 && !this.$2D_4) {
            return false;
        }
        ...
        if (this.$12_2) {
            if (!Srch.U.n(this.$m_4) && this.$m_4.length > 0) {
                for (var $v_0 = 0; $v_0 < this.$m_4.length; $v_0++) {
                    ...
                    Srch.U.appendScriptsToLoad(this.$2k_4, $v_1);
                }
            }
            this.$1_2('ScriptApplication_PreLoad', 'Yield loading preloaded item templates.');
            window.setTimeout(this.$$d_$5Z_4, 0);
            Srch.U.appendScriptsToLoad(this.serverTemplateScriptsToLoad, this.$1w_4);
    ...
    $5Z_4: function Srch_Result$$5Z_4$in() {
        this.$1_2('LoadPreloadedItemTemplateScripts', 'Trying to load preloaded item template scripts...');
        this.loadRenderTemplateScripts(this.$2k_4, this.$$d_$5m_4, this.$$d_$5m_4, -1, true);
    },
    
    $5m_4: function Srch_Result$$5m_4$in() {
    ...
    sortOrRank: function Srch_Result$sortOrRank$in(sortRankName) {
        ...
        if (sortRankName === Srch.Res.rs_SocialDistanceSort) {
            ...
            if ($v_0.$2_3.m === Srch.DataProvider.$3V || $v_0.$2_3.m === Srch.DataProvider.$20) {
                $v_1.m = Srch.DataProvider.$20;
            }
            else if ($v_0.$2_3.m === Srch.DataProvider.$3G || $v_0.$2_3.m === Srch.DataProvider.$1n) {
                $v_1.m = Srch.DataProvider.$1n;
            }
            else {
                $v_1.m = Srch.DataProvider.$2e;
            }
            $v_0.$2_3.o = null;
            $v_1.s = 1;
    ...
    $4s_4: function Srch_Result$$4s_4$in($p0, $p1) {
        if (Srch.U.e($p0)) {
            return;
        }
        var $v_0 = this.get_dataProvider();
        ...
        if (!Srch.U.n($v_1) && $v_1.length > 0) {
            for (var $v_2 = 0; $v_2 < $v_1.length; $v_2++) {
                ...
                if (!Srch.U.n($v_3) && $v_3.name === $p0) {
                    ...
                    $v_4.o = $v_3.sorts;
                    if ($p1) {
                        if ($v_0.$2_3.m === Srch.DataProvider.$20) {
                            $v_4.m = Srch.DataProvider.$3V;
                        }
                        else if ($v_0.$2_3.m === Srch.DataProvider.$1n) {
                            $v_4.m = Srch.DataProvider.$3G;
                        }
                        else if ($v_0.$2_3.m === Srch.DataProvider.$2e) {
    ...
    shouldShowTable: function Srch_Result$shouldShowTable$in(resultTable) {
        if (!Srch.U.n(resultTable)) {
            ...
            if (!Srch.U.n($v_0) && $v_0 > 0) {
                if (this.$2E_4 && Srch.U.isTableTypeof(resultTable, Microsoft.SharePoint.Client.Search.Query.KnownTableTypes.relevantResults)) {
                    this.$I_3 = true;
                    return true;
                }
                else if (this.$2B_4 && Srch.U.isTableTypeof(resultTable, Microsoft.SharePoint.Client.Search.Query.KnownTableTypes.specialTermResults)) {
                    this.$I_3 = true;
                    return true;
                }
                else if (this.$2C_4 && Srch.U.isTableTypeof(resultTable, Microsoft.SharePoint.Client.Search.Query.KnownTableTypes.definitionResults)) {
                    this.$I_3 = true;
                    return true;
                }
                else if (this.$2D_4 && Srch.U.isTableTypeof(resultTable, Microsoft.SharePoint.Client.Search.Query.KnownTableTypes.personalFavoriteResults)) {
                    this.$I_3 = true;
                    return true;
                }
            }
    ...
    $4Z_4: function Srch_Result$$4Z_4$in($p0) {
        this.$H_4 = null;
        if (Srch.U.n($p0)) {
            return;
        }
        ...
        var $v_4 = (this.$10_4 > this.$1C_4) ? this.$10_4 - this.$1C_4 : 1;
...
Srch.SearchBox = function Srch_SearchBox(elem) {
    ...
    this.$$d_$62_3 = Function.createDelegate(this, this.$62_3);
    this.$$d_dataProvider_ResultReady = Function.createDelegate(this, this.dataProvider_ResultReady);
    this.$$d_dataProvider_QueryIssuing = Function.createDelegate(this, this.dataProvider_QueryIssuing);
...
Srch.SearchBox.prototype = {
            ...
            if (!Srch.U.n(this.$N_3)) {
                for (var $v_0 = 0; $v_0 < this.$N_3.length; $v_0++) {
                    ...
                    if (!Srch.U.n($v_1)) {
                        ...
                        if (!Srch.U.n($v_2)) {
                            Srch.U.appendArray(this.$1d_3, $v_2);
                        }
                    }
                }
            }
    ...
    get_showNavigation: function Srch_SearchBox$get_showNavigation$in() {
        return this.$3m_3 && !Srch.U.n(this.$1E_3) && this.$1E_3.length > 1;
    },
    ...
    $1L_3: 'ms-srch-sb-prompt ms-helperText',
    ...
    dataProvider_QueryStateChanged: function Srch_SearchBox$dataProvider_QueryStateChanged$in(sender, e) {
        ...
        if (!Srch.U.n($v_0)) {
            ...
            if (!Srch.U.n($v_1)) {
                ...
                if (this.$37_3) {
                    var $v_2 = (Srch.U.e(this.$22_3)) ? Srch.Res.sb_ResultsPageTitle : this.$22_3;
    ...
    setBorder: function Srch_SearchBox$setBorder$in(focused) {
        ...
        if (!Srch.U.n($v_0) && !Srch.U.n($v_1)) {
            focused = !!(focused | (!Srch.U.e($v_1.value) && $v_1.value !== this.$E_3));
    ...
    dataProvider_QueryIssuing: function Srch_SearchBox$dataProvider_QueryIssuing$in(sender, e) {
        this.$1_2('DataProvider_QueryIssuing', '');
        this.$4M_3();
        this.$2o_3 = window.setTimeout(this.$$d_$62_3, this.$2g_3);
        this.$1K_3 = true;
    },
    ...
    $62_3: function Srch_SearchBox$$62_3$in() {
        if (!this.$1K_3) {
            return;
        }
        window.clearTimeout(this.$2o_3);
        this.$1K_3 = false;
    ...
    $4M_3: function Srch_SearchBox$$4M_3$in() {
        if (this.$1K_3) {
            window.clearTimeout(this.$2o_3);
            this.$1K_3 = false;
        }
        var $v_0 = this.get_searchBoxLinkElement();
        if (!Srch.U.n($v_0)) {
            $v_0.className = $v_0.className.replace(new RegExp(' ' + this.$1Q_3, 'gi'), '');
            if (!Srch.U.n(this.$1G_3)) {
                $v_0.title = this.$1G_3;
                this.$1G_3 = null;
            }
    ...
    search: function Srch_SearchBox$search$in(term) {
        ...
        if (!this.$33_3 || Srch.U.n($v_3)) {
            var $v_4 = Srch.U.getResultsPageUrl(this.$2u_3, term);
            if (!Srch.U.e($v_4)) {
        ...
        this.$U_3 = term;
        EnsureScript('sp.search.js', TypeofFullName('Microsoft.SharePoint.Client.Search.Query.KeywordQuery'), this.$$d_$60_3);
        Srch.ScriptApplicationManager.get_current().$3z_1();
    },
    
    $60_3: function Srch_SearchBox$$60_3$in() {
    ...
    hidePrompt: function Srch_SearchBox$hidePrompt$in() {
        var $v_0 = this.get_searchBoxInputElement();
        if (Srch.U.n($v_0) || Srch.U.e(this.$E_3)) {
            return;
        }
        if ($v_0.value === this.$E_3) {
            $v_0.value = '';
            Srch.U.ensureCSSClassNameNotExist($v_0, this.$1L_3);
        }
    },
    ...
    showPrompt: function Srch_SearchBox$showPrompt$in() {
        ...
        if ($v_0.value === '') {
            $v_0.value = this.$E_3;
            Srch.U.ensureCSSClassNameExist($v_0, this.$1L_3);
        }
    },
    ...
    activate: function Srch_SearchBox$activate$in(prompt, searchBoxInputId, searchBoxContainerId, navigationButtonId, suggestionsListId, navigationListId, searchBoxLinkId, searchBoxProgressClass, searchBoxPromptClass) {
        ...
        this.$21_3 = navigationButtonId;
        this.$J_3 = suggestionsListId;
        this.$G_3 = navigationListId;
        this.$1P_3 = searchBoxLinkId;
        this.$1Q_3 = searchBoxProgressClass;
        this.set_currentPrompt(prompt);
        this.$1L_3 = searchBoxPromptClass;
        this.showPrompt();
    },
    ...
    $5A_3: function Srch_SearchBox$$5A_3$in() {
        if (Srch.U.n(this.$x_3[this.$G_3])) {
            ...
            Srch.U.createBehavior(this.$G_3, AjaxControlToolkit.DropdownListBehavior, $v_0, this.$21_3);
            this.$x_3[this.$G_3] = true;
        }
    },
    
    $5B_3: function Srch_SearchBox$$5B_3$in() {
        if (Srch.U.n(this.$x_3[this.$J_3])) {
            var $v_0 = {};
            $v_0['id'] = this.$J_3;
            $v_0['completionInterval'] = this.$2p_3;
            ...
            $v_0['highlightedItemCssClass'] = 'ms-qSuggest-hListItem';
            $v_0['minimumPrefixLength'] = this.$2r_3;
            $v_0['offsetWidth'] = -2;
            $v_0['queryCount'] = this.$2q_3;
            $v_0['personalResultCount'] = this.$2j_3;
            $v_0['showPeopleNameSuggestions'] = this.$31_3;
    ...
    $44_3: function Srch_SearchBox$$44_3$in($p0) {
        var $v_0 = {};
        $v_0['__'] = $p0;
        var $v_1 = {};
        $v_1['QueryErrors'] = $v_0;
    ...
    $3d_3: function Srch_SearchBox$$3d_3$in() {
        this.$x_3 = {};
...
Srch.U.isPageInEditMode = function Srch_U$isPageInEditMode$st() {
    if (Srch.U.e(Srch.U.$1a)) {
        var $v_0 = $get('MSOSPWebPartManager_DisplayModeName');
        if (!Srch.U.n($v_0)) {
            Srch.U.$1a = $v_0.value;
        }
    }
    if (Srch.U.$1a === 'Edit' || Srch.U.$1a === 'Design') {
        return true;
    }
    else {
        return false;
...
Srch.U.ensureNotNullOrUndefined = function Srch_U$ensureNotNullOrUndefined$st(value, context, methodName, paraName) {
    ...
    if (!value) {
        Srch.U.$2I(Error.argumentNull($v_0 + methodName + '.' + paraName));
    }
    else if (typeof(value) === 'undefined') {
        Srch.U.$2I(Error.argumentUndefined($v_0 + methodName + '.' + paraName));
    }
}
Srch.U.ensureNotNullOrEmptyString = function Srch_U$ensureNotNullOrEmptyString$st(value, context, methodName, paraName) {
    ...
    if (!value) {
        ...
        Srch.U.$2I(Error.argumentOutOfRange($v_0 + methodName + '.' + paraName));
    }
}
Srch.U.encodeUrlForHtmlAttributes = function Srch_U$encodeUrlForHtmlAttributes$st(url) {
    ...
    var $v_0 = [ new RegExp('&', 'g'), new RegExp('<', 'g'), new RegExp('>', 'g'), new RegExp('\"', 'g') ];
    url = url.replace($v_0[0], '&amp;');
    url = url.replace($v_0[1], '&lt;');
    url = url.replace($v_0[2], '&gt;');
    return url.replace($v_0[3], '&quot;');
}
...
Srch.U.$2I = function Srch_U$$2I$st($p0) {
    alert($p0.message);
    throw $p0;
}
Srch.U.$59 = function Srch_U$$59$st($p0, $p1) {
...
Srch.U.$5Y = function Srch_U$$5Y$st($p0, $p1) {
...
Srch.U.$45 = function Srch_U$$45$st($p0, $p1) {
...
Srch.U.$2S = function Srch_U$$2S$st($p0, $p1) {
    if (!Srch.U.n($p0)) {
        var $v_0 = [];
        for (var $v_1 = 0; $v_1 < $p0.length; $v_1++) {
...
Srch.U.setCookie = function Srch_U$setCookie$st(name, value, expires, domain, path) {
...
Srch.U.$4O = function Srch_U$$4O$st($p0, $p1, $p2) {
    if (Srch.U.e($p0)) {
        if ($p1) {
            return true;
        }
...
Srch.U.fillKeywordQuery = function Srch_U$fillKeywordQuery$st(query, dp) {
    ...
    if ((dp.$R_3) && (!Srch.U.e(dp.$1H_3))) {
        query.set_impressionID(dp.$1H_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'ImpressionID is \'{0}\'', query.get_impressionID());
    }
    if (!Srch.U.n(dp.$2J_3)) {
        query.set_timeZoneId(dp.$2J_3);
    ...
    if (!Srch.U.w(dp.$1T_3)) {
        query.set_sourceId(new SP.Guid(dp.$1T_3));
    ...
    if (!Srch.U.w(dp.$1V_3) && !Srch.U.w(dp.$1U_3)) {
        query.get_properties().set_item('SourceName', dp.$1V_3);
        query.get_properties().set_item('SourceLevel', dp.$1U_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'SourceName is \'{0}\' and SourceLevel is \'{1}\'', dp.$1V_3, dp.$1U_3);
    }
    else {
    ...
    else if (!Srch.U.e(dp.$1p_3)) {
        query.set_rankingModelId(dp.$1p_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'RankingModelId is \'{0}\'', query.get_rankingModelId());
    }
    if ($v_0.enableStemming !== dp.$1m_3) {
        query.set_enableStemming(dp.$1m_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'EnableStemming is \'{0}\'', query.get_enableStemming());
    }
    if ($v_0.enablePhonetic !== dp.$1k_3) {
        query.set_enablePhonetic(dp.$1k_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'EnablePhonetic is \'{0}\'', query.get_enablePhonetic());
    }
    if ($v_0.enableNicknames !== dp.$1i_3) {
        query.set_enableNicknames(dp.$1i_3);
        Srch.U.traceFormatted(null, 'Refiners', 'EnableNicknames is \'{0}\'', query.get_enableNicknames());
    }
    if ($v_0.trimDuplicates !== dp.$2K_3) {
        query.set_trimDuplicates(dp.$2K_3);
    ...
    if (dp.$2i_3 && !Srch.U.n(Srch.ScriptApplicationManager.get_current().states['currentUserProfileId'])) {
    ...
    if ($v_0.enableInterleaving !== dp.$1h_3) {
        query.set_enableInterleaving(dp.$1h_3);
    ...
    if (dp.$2_3.e > 0) {
        ...
        if ($v_0.enableQueryRules !== dp.$1l_3) {
            query.set_enableQueryRules(dp.$1l_3);
            Srch.U.traceFormatted(null, 'FillKeywordQuery', 'EnableQueryRules is \'{0}\'', query.get_enableQueryRules());
        }
    }
    ...
    if ($v_0.summaryLength !== dp.$2G_3) {
        query.set_summaryLength(dp.$2G_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'SummaryLength is \'{0}\'', query.get_summaryLength());
    }
    if ($v_0.desiredSnippetLength !== dp.$1f_3) {
        query.set_desiredSnippetLength(dp.$1f_3);
    ...
    if (!Srch.U.e(dp.$1X_3)) {
        query.set_collapseSpecification(dp.$1X_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'CollapseSpecification is \'{0}\'', query.get_collapseSpecification());
    }
    if ($v_0.processPersonalFavorites !== dp.$2A_3) {
        query.set_processPersonalFavorites(dp.$2A_3);
        Srch.U.traceFormatted(null, 'FillKeywordQuery', 'ProcessPersonalFavorites is \'{0}\'', query.get_processPersonalFavorites());
    }
    if ($v_0.enableOrderingHitHighlightedProperty !== dp.$1j_3) {
        query.set_enableOrderingHitHighlightedProperty(dp.$1j_3);
    ...
    if ($v_0.hitHighlightedMultivaluePropertyLimit !== dp.$1v_3) {
        query.set_hitHighlightedMultivaluePropertyLimit(dp.$1v_3);
    ...
    if (!SP.ScriptUtility.isNullOrEmptyString(dp.$25_3)) {
        query.set_safeQueryPropertiesTemplateUrl(dp.$25_3);
...
Srch.U.$4F = function Srch_U$$4F$st($p0, $p1) {
...
Srch.U.parseTypedRangeToken = function Srch_U$parseTypedRangeToken$st(rangeFilterToken, objToStoreFilterTokenType) {
    ...
    if (!Srch.U.n($v_1) && $v_1.length > 2) {
        $v_1[1] = Srch.U.$2h($v_1[1], objToStoreFilterTokenType);
        $v_1[2] = Srch.U.$2h($v_1[2], objToStoreFilterTokenType);
    }
    return $v_1;
}
Srch.U.$2h = function Srch_U$$2h$st($p0, $p1) {
    var $v_0 = new RegExp('([^(]*)\\(([^)]*)\\)');
    var $v_1 = $v_0.exec($p0);
...
Srch.U.modifyMediaDurationRefinementName = function Srch_U$modifyMediaDurationRefinementName$st(resultRow) {
    ...
    $v_5 = Srch.U.$2h($v_5, null);
    var $v_6 = $v_0.substring($v_2 + 1, $v_3).trim();
    $v_6 = Srch.U.$2h($v_6, null);
...
Srch.U.$2X = function Srch_U$$2X$st($p0) {
    if (!isNaN($p0) && $p0 >= 0) {
...
Srch.U.registerRenderTemplateByName = function Srch_U$registerRenderTemplateByName$st(name, template) {
    if (Srch.U.e(name) || Srch.U.n(template)) {
        ...
        Srch.ScriptApplicationManager.get_current().$1M_1[name.toLowerCase()] = template;
    }
}
Srch.U.getRenderTemplateCollection = function Srch_U$getRenderTemplateCollection$st() {
    return Srch.ScriptApplicationManager.get_current().$1M_1;
}
Srch.U.getRenderTemplateByName = function Srch_U$getRenderTemplateByName$st(name, renderCtx) {
    ...
    var $v_0 = Srch.ScriptApplicationManager.get_current().$1M_1[name.toLowerCase()];
    if (!Srch.U.e($v_0)) {
        return $v_0;
    }
    ...
    if (!Srch.U.e($v_1)) {
        ...
        $v_0 = Srch.ScriptApplicationManager.get_current().$1M_1[$v_1];
        if (!Srch.U.e($v_0)) {
            return $v_0;
        }
    }
    ...
    if (!OffSwitch.IsActive('BDFB227C-6B80-42DB-92FD-E1463B8DE52A')) {
        var $v_3 = Srch.ScriptApplicationManager.get_current().$1M_1['~sitecollection/_catalogs/masterpage/Display Templates/Search/Item_Default.js'.toLowerCase()];
        if (!Srch.U.e($v_3)) {
            return $v_3;
        }
    }
...
Srch.U.$40 = function Srch_U$$40$st($p0, $p1) {
    return Srch.U.setFieldOnObject($p0, Srch.U.$1W, $p1);
}
Srch.U.$51 = function Srch_U$$51$st($p0, $p1, $p2) {
    var $v_0 = {};
    $v_0[Srch.U.$3B] = $p1;
    $v_0[Srch.U.$1W] = $p2;
    return Srch.U.setFieldOnObject($p0, Srch.U.$3A, $v_0);
}
Srch.U.getTemplateUrlFromFunctionOrRenderCtx = function Srch_U$getTemplateUrlFromFunctionOrRenderCtx$st(templateFunctionOrRenderCtx) {
    var $v_0 = Srch.U.getFieldOnObject(templateFunctionOrRenderCtx, Srch.U.$2T);
...
Srch.U.createErrorObjectWithExecContext = function Srch_U$createErrorObjectWithExecContext$st(messageText, operationName, templateFuncOrRenderCtx) {
    ...
    if (typeof($v_1) !== 'function') {
        var $v_2 = {};
        $v_2[Srch.U.$2T] = Srch.U.getFieldOnObject(templateFuncOrRenderCtx, Srch.U.$2T);
        $v_1 = $v_2;
    }
...
Srch.U.resolveRenderTemplate = function Srch_U$resolveRenderTemplate$st(renderCtx, component, level) {
    ...
    if (level === 'Item') {
        ...
        return Srch.U.getRenderTemplateByName($v_0.$27_2, renderCtx);
    }
    else if (level === 'Body') {
...
Srch.U.getHighlightedProperty = function Srch_U$getHighlightedProperty$st(key, result, property) {
    ...
    if (!Srch.U.e(key)) {
        if (!((key) in Srch.ScriptApplicationManager.get_current().$2d_1)) {
            Srch.ScriptApplicationManager.get_current().$2d_1[key] = Srch.U.$5l(result['HitHighlightedProperties']);
        }
...
Srch.U.createXMLDocument = function Srch_U$createXMLDocument$st(xml) {
    ...
    if (!Srch.U.n($v_1)) {
        try {
            if (Srch.U.n(Srch.U.$2U)) {
                Srch.U.$2U = new DOMParser();
            }
            Srch.U.trace(null, 'CreateXMLDocument', 'Loading XML using DOMParser...');
            return Srch.U.$2U.parseFromString(xml, 'text/xml');
        }
        catch ($v_2) {
    ...
    if (!Srch.U.n($v_0)) {
        try {
            if (Srch.U.n(Srch.U.$1D)) {
                Srch.U.$1D = new ActiveXObject('MSXML.DomDocument');
            }
            Srch.U.$1D.preserveWhiteSpace = true;
            Srch.U.$1D.loadXML(xml);
...
Srch.U.$5Q = function Srch_U$$5Q$st($p0, $p1, $p2) {
    var $v_0 = 0;
    if (!Srch.U.e($p0)) {
        $v_0 = $p0.length;
        if (!Srch.U.e($p1)) {
...
Srch.U.$4w = function Srch_U$$4w$st($p0, $p1, $p2, $p3, $p4) {
...
Srch.U.$3X = function Srch_U$$3X$st($p0) {
    var $v_0 = '';
    if (!Srch.U.n($p0)) {
...
Srch.U.$4K = function Srch_U$$4K$st($p0) {
    var $v_0 = '';
    if (!Srch.U.n($p0)) {
        $v_0 = $p0.nodeValue;
        if (Srch.U.e($v_0)) {
...
Srch.U.$5c = function Srch_U$$5c$st($p0, $p1) {
...
Srch.U.$5a = function Srch_U$$5a$st($p0, $p1) {
    ...
    if (!$p1.progress) {
        ...
        if (!Srch.U.n($p1.scriptsToLoad)) {
            for (var $v_1 = 0; $v_1 < $p1.scriptsToLoad.length; $v_1++) {
                ...
                if (!Srch.U.w($v_2) && Srch.U.n(Srch.ScriptApplicationManager.get_current().$1B_1[$v_2])) {
                    Srch.U.appendArray($v_0, $v_2);
                }
            }
        }
...
Srch.U.appendScriptsToLoad = function Srch_U$appendScriptsToLoad$st(scripts, script) {
    if (!Srch.U.w(script)) {
        ...
        if (!Srch.U.w(script) && script.endsWith('.js')) {
            ...
            else if (!Srch.U.n(Srch.ScriptApplicationManager.get_current().$1B_1[script])) {
    ...
    if (!Srch.U.n(scripts)) {
        for (var $v_0 = 0; $v_0 < scripts.length; $v_0++) {
            ...
            if (!Srch.U.w($v_1)) {
                ...
                Srch.ScriptApplicationManager.get_current().$1B_1[$v_1] = true;
            }
        }
    }
}
...
Srch.U.$3L = function Srch_U$$3L$st($p0, $p1) {
    if (Srch.U.e($p1)) {
        return '';
    }
    var $v_0 = $p1;
...
Srch.U.$4q = function Srch_U$$4q$st($p0) {
    if ($p0.readyState === 4) {
        if ($p0.status === 200) {
...
Srch.U.$3a = function Srch_U$$3a$st($p0, $p1) {
    Srch.U.traceFormatted(null, 'RegisterCustomScript', 'scriptLink:\'{0}\' languageScript:\'{1}\'', $p0, $p1);
    Srch.ScriptApplicationManager.get_current().$1c_1[$p0] = $p1;
    if ($p1) {
        var $v_0 = Srch.U.$2Z();
        var $v_1 = Srch.U.$2Y();
        if ($v_0 !== $v_1) {
            var $v_2 = Srch.U.$5S($p0);
            Srch.ScriptApplicationManager.get_current().$1c_1[$v_2] = $p1;
        }
    }
}
...
Srch.U.$4N = function Srch_U$$4N$st() {
    var $v_0 = Srch.Res;
    return (Srch.U.n($v_0)) ? null : $v_0;
}
Srch.U.$C = function Srch_U$$C$st($p0, $p1) {
    return Srch.U.$4R($p0, $p1, null);
}
Srch.U.$4R = function Srch_U$$4R$st($p0, $p1, $p2) {
    var $v_0 = '';
    var $v_1 = false;
    var $v_2 = Srch.U.$4N();
    var $v_3 = Srch.U.$2Z();
    ...
    if (Srch.U.n($v_5.$D_1)) {
        ...
        var $v_6 = $v_5.$D_1[$v_3];
        var $v_7 = $v_5.$D_1[$v_4];
        $v_0 = Srch.U.$1u($p0, $v_6);
        if (Srch.U.e($v_0)) {
            $v_0 = Srch.U.$1u($p0, $v_7);
        }
        $v_1 = (!Srch.U.n($v_6) || !Srch.U.n($v_7));
    }
    if (Srch.U.e($v_0)) {
        $v_0 = Srch.U.$1u($p0, $v_2);
    }
    if (!Srch.U.e($v_0)) {
        return $v_0;
    }
...
Srch.U.$5z = function Srch_U$$5z$st() {
    Srch.ScriptApplicationManager.get_current().$D_1['Warnings'] = [];
}
Srch.U.$3N = function Srch_U$$3N$st() {
    var $v_0 = Srch.ScriptApplicationManager.get_current().$D_1['Warnings'];
    if (Srch.U.n($v_0)) {
        $v_0 = [];
        Srch.ScriptApplicationManager.get_current().$D_1['Warnings'] = $v_0;
    }
    return $v_0;
}
Srch.U.$2Z = function Srch_U$$2Z$st() {
    return Srch.ScriptApplicationManager.get_current().states['webUILanguageName'];
}
Srch.U.$4J = function Srch_U$$4J$st() {
    return Srch.ScriptApplicationManager.get_current().states['webUILanguageDirectory'];
}
Srch.U.$2Y = function Srch_U$$2Y$st() {
    return Srch.ScriptApplicationManager.get_current().states['webDefaultLanguageName'];
}
Srch.U.$5e = function Srch_U$$5e$st($p0, $p1, $p2) {
    var $v_0 = Srch.U.$4N();
    var $v_1 = Srch.U.$2Z();
    if (!Srch.U.w($v_1)) {
        $v_1 = $v_1.toLowerCase();
    ...
    var $v_5 = '';
    if ($p1) {
        $v_5 = Srch.U.$1u('cc_err_CustomLocStringWarningDisplayHeaderFormat', $v_0);
    }
    else {
        $v_5 = Srch.U.$1u('cc_err_NoCustomLoadedLocStringWarningDisplayHeaderFormat', $v_0);
    }
    if (!Srch.U.e($v_5)) {
...
Srch.U.$1u = function Srch_U$$1u$st($p0, $p1) {
    if (!Srch.U.n($p1)) {
        if (!Srch.U.n($p1[$p0])) {
            return $p1[$p0];
        }
...
Srch.U.registerResourceDictionary = function Srch_U$registerResourceDictionary$st(locale, dict) {
    if (!Srch.U.e(locale)) {
        ...
        if (Srch.U.n(Srch.ScriptApplicationManager.get_current().$D_1[$v_0])) {
            Srch.ScriptApplicationManager.get_current().$D_1[$v_0] = dict;
        }
        else if (!Srch.U.n(dict)) {
            var $$dict_4 = dict;
            for (var $$key_5 in $$dict_4) {
                var $v_1 = { key: $$key_5, value: $$dict_4[$$key_5] };
                (Srch.ScriptApplicationManager.get_current().$D_1[$v_0])[$v_1.key] = $v_1.value;
            }
        }
    }
}
Srch.U.$5S = function Srch_U$$5S$st($p0) {
...
Srch.ListenedEvent.prototype = {
    ...
    dispose: function Srch_ListenedEvent$dispose$in() {
        if (!Srch.U.n(this.$K_0) && !Srch.U.n(this.$F_0)) {
            if (Srch.DisplayControl.isInstanceOfType(this.$K_0)) {
                var $v_0 = this.$K_0;
                if (this.$Q_0 === 1) {
                    $v_0.remove_queryReady(this.$F_0);
                }
            }
            else if (Srch.DataProvider.isInstanceOfType(this.$K_0)) {
                var $v_1 = this.$K_0;
                if (this.$Q_0 === 2) {
                    $v_1.remove_queryIssuing(this.$F_0);
                }
                else if (this.$Q_0 === 4) {
                    $v_1.remove_resultReady(this.$F_0);
                }
                else if (this.$Q_0 === 6) {
                    $v_1.remove_queryStateChanged(this.$F_0);
                }
            }
            else if (Srch.SearchBox.isInstanceOfType(this.$K_0)) {
                var $v_2 = this.$K_0;
                if (this.$Q_0 === 1) {
                    $v_2.remove_queryReady(this.$F_0);
                }
                else if (this.$Q_0 === 3) {
                    $v_2.remove_batchQueryIssuing(this.$F_0);
                }
                else if (this.$Q_0 === 5) {
                    $v_2.remove_batchResultReady(this.$F_0);
                }
            }
        }
    }
...
Srch.ScriptApplicationManager.get_current = function Srch_ScriptApplicationManager$get_current$st() {
    if (Srch.U.n(Srch.ScriptApplicationManager.$1Z)) {
        Srch.ScriptApplicationManager.$1Z = $create(Srch.ScriptApplicationManager);
    }
    Srch.U.ensureNotNullOrUndefined(Srch.ScriptApplicationManager.$1Z, null, 'Current', 'ScriptApplicationManager.current');
    return Srch.ScriptApplicationManager.$1Z;
}
...
Srch.ScriptApplicationManager.prototype = {
    ...
    getDisplayNameByLanguageID: function Srch_ScriptApplicationManager$getDisplayNameByLanguageID$in(lcid) {
        ...
        if (!this.$19_1) {
            ...
            for (var $v_2 = 0; $v_2 < $v_0.length; $v_2++) {
                var $v_3 = $v_0[$v_2];
                this.$19_1[$v_3.id.toString()] = $v_3;
            }
        }
        var $v_1 = this.$19_1[lcid.toString()];
        if (!Srch.U.n($v_1)) {
            return $v_1.label;
        }
        lcid = lcid & 1023;
    ...
    $53_1: function Srch_ScriptApplicationManager$$53_1$in($p0, $p1) {
    ...
    navigateTo: function Srch_ScriptApplicationManager$navigateTo$in(url, fullNavigate) {
        ...
        for (var $$key_A in $$dict_9) {
            ...
            var $v_5 = $v_4.value;
            if (!Srch.U.n($v_5) && !Srch.U.n($v_5.dataProvider) && $v_5.dataProvider.$2L_3) {
                $v_0++;
                var $v_6 = $v_5.dataProvider.$2_3.$5t_0();
    ...
    $3z_1: function Srch_ScriptApplicationManager$$3z_1$in() {
        this.navigateTo(null, false);
    },
    
    $3F_1: function Srch_ScriptApplicationManager$$3F_1$in($p0) {
...
Srch.QueryState.$5V = function Srch_QueryState$$5V$st($p0) {
    if (Srch.U.n($p0)) {
        return false;
    }
    var $$dict_2 = $p0;
...
Srch.QueryState.$43 = function Srch_QueryState$$43$st($p0, $p1) {
    if (!Srch.U.n($p0)) {
...
Srch.QueryState.$5C = function Srch_QueryState$$5C$st() {
    var $v_0 = false;
    var $v_1 = new Srch.QueryState();
    var $v_2 = $v_1;
...
Srch.QueryState.$5N = function Srch_QueryState$$5N$st() {
    var $v_0 = new Srch.QueryState();
    $v_0.k = null;
    return $v_0;
}
Srch.QueryState.prototype = {
    ...
    copyFrom: function Srch_QueryState$copyFrom$in(qs, option) {
        ...
        if (!option || qs.o !== Srch.QueryState.$4.o) {
            if (!Srch.U.n(qs.o)) {
                this.o = Srch.U.$2S(qs.o, Srch.ResultSort);
            }
            else {
        ...
        if (!option || qs.x !== Srch.QueryState.$4.x) {
            if (!Srch.U.n(qs.x)) {
                this.x = Srch.U.$2S(qs.x, Srch.RankRule);
            }
            else {
        ...
        if (!option || option === 1 || qs.r !== Srch.QueryState.$4.r) {
            if (!Srch.U.n(qs.r)) {
                this.r = Srch.U.$2S(qs.r, Srch.RefinementCategory);
            }
            else {
    ...
    $38_0: function Srch_QueryState$$38_0$in($p0, $p1) {
        if (Srch.U.n($p0) && Srch.U.n($p1)) {
            return true;
        }
        if (Srch.U.n($p0) || Srch.U.n($p1)) {
    ...
    equalsTo: function Srch_QueryState$equalsTo$in(qs) {
        ...
        if (!this.$38_0(this.r, qs.r) || !this.$38_0(this.x, qs.x) || !this.$38_0(this.o, qs.o)) {
            return false;
        }
        return true;
    },
    
    $5t_0: function Srch_QueryState$$5t_0$in() {
        var $v_0 = Srch.QueryState.$4;
        var $v_1 = this;
        var $v_2 = {};
        var $$dict_4 = $v_0;
...
Srch.ControlMessage.$4H = function Srch_ControlMessage$$4H$st($p0) {
    var $v_0 = '';
    if (!Srch.U.n($p0)) {
        ...
        try {
            ...
            var $v_1 = Srch.U.getFieldOnObject($p0, Srch.U.$3A);
            var $v_2 = Srch.ControlMessage.$5U($v_1);
            var $v_3 = Srch.U.getStringFieldOnObject($v_1, Srch.U.$3B);
...
Srch.ControlMessage.$5U = function Srch_ControlMessage$$5U$st($p0) {
    var $v_0 = Srch.U.getFieldOnObject($p0, Srch.U.$1W);
    var $v_1 = Srch.U.getTemplateUrlFromFunctionOrRenderCtx($v_0);
    var $v_2 = Srch.U.getFieldOnObject($v_0, Srch.U.$1W);
...
Srch.ClickRecorder.recordPageClick = function Srch_ClickRecorder$recordPageClick$st(clickInformation) {
    ...
    EnsureScript('sp.search.js', TypeofFullName('Microsoft.SharePoint.Client.Search.Query.SearchExecutor'), Srch.ClickRecorder.$5q);
}
Srch.ClickRecorder.$5q = function Srch_ClickRecorder$$5q$st() {
...
Srch.ValueInfo.$5O = function Srch_ValueInfo$$5O$st($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = '';
    $p4.val = '';
    if (Srch.U.n($p0) && Srch.U.n($p1)) {
        return '';
...
Srch.ValueInfo.getValueOrValuesArray = function Srch_ValueInfo$getValueOrValuesArray$st(inputValue, managedProperty, isAllDayEvent) {
...
Srch.ValueInfo.getValuesCollection = function Srch_ValueInfo$getValuesCollection$st(inputMultiValueEntityStrings, managedProperty, isAllDayEvent) {
    var $v_0 = [];
        ...
        for (var $$arr_7 = activeMappedProps, $$len_8 = $$arr_7.length, $$idx_9 = 0; $$idx_9 < $$len_8; ++$$idx_9) {
            ...
            if (($v_4) in $v_2) {
                ...
                for (var $$key_E in $$dict_D) {
                    var $v_6 = { key: $$key_E, value: $$dict_D[$$key_E] };
...
Srch.ValueInfo.prototype = {
    ...
    $65_0: function Srch_ValueInfo$$65_0$in() {
        if (Srch.U.isArray(this.inputValue)) {
            return;
        }
        try {
            var $v_0 = Srch.ValueInfo.ValueTypeHandler.$2W(this.managedPropertyName, null);
    ...
    getRenderedValue: function Srch_ValueInfo$getRenderedValue$in() {
        ...
        if (!Srch.U.n(this.$1b_0)) {
            $v_1 = this.$1b_0;
        }
        var $v_2 = ((!Srch.U.n(this.$1b_0)) ? 'OverrideValueRenderer' : (!Srch.U.n(this.defaultValueRenderer)) ? 'Default renderer for type' : 'Core DefaultRenderedValueHtmlEncoded');
    ...
    getFilterToken: function Srch_ValueInfo$getFilterToken$in() {
        if (!Srch.U.n(this.$2Q_0)) {
            this.$13_0 = true;
            var $v_0 = this.$2Q_0(this);
            this.$13_0 = false;
            return $v_0;
        }
        else {
...
Srch.ValueInfo.Parsers.$63 = function Srch_ValueInfo_Parsers$$63$st($p0) {
...
Srch.ValueInfo.Parsers.$67 = function Srch_ValueInfo_Parsers$$67$st($p0) {
    if (Srch.U.n($p0) || Srch.U.n($p0.inputValue) || Srch.U.w($p0.inputValue.toString())) {
        return;
    }
...
Srch.ValueInfo.Parsers.$5i = function Srch_ValueInfo_Parsers$$5i$st($p0) {
...
Srch.ValueInfo.Parsers.$5j = function Srch_ValueInfo_Parsers$$5j$st($p0) {
    if (Srch.U.n($p0) || Srch.U.n($p0.inputValue) || (Number.isInstanceOfType($p0.inputValue)) || Srch.U.w($p0.inputValue.toString())) {
        return;
    }
...
Srch.ValueInfo.Parsers.$3C = function Srch_ValueInfo_Parsers$$3C$st($p0) {
...
Srch.ValueInfo.Parsers.$55 = function Srch_ValueInfo_Parsers$$55$st($p0) {
...
Srch.ValueInfo.Parsers.$66 = function Srch_ValueInfo_Parsers$$66$st($p0) {
    if (Srch.U.n($p0) || Srch.U.n($p0.inputValue) || (Boolean.isInstanceOfType($p0.inputValue)) || Srch.U.w($p0.inputValue.toString())) {
        return;
    }
...
Srch.ValueInfo.Renderers.defaultDateRenderer = function Srch_ValueInfo_Renderers$defaultDateRenderer$st(valueObject) {
    if (!Srch.U.n(valueObject) && !valueObject.isEmpty && (Date.isInstanceOfType(valueObject.value))) {
        ...
        if ($v_1) {
            ...
            $v_4 = $v_4 + Srch.ValueInfo.Renderers.$5k($v_1);
...
Srch.ValueInfo.Renderers.defaultDateInvariantRenderer = function Srch_ValueInfo_Renderers$defaultDateInvariantRenderer$st(valueObject) {
    if (!Srch.U.n(valueObject) && !valueObject.isEmpty && (Date.isInstanceOfType(valueObject.value))) {
        var $v_0 = Srch.U.$C(String.format('cc_ValueRendererDateFormat_{0}', valueObject.managedPropertyName), false);
        if (Srch.U.w($v_0)) {
            $v_0 = 'LongDatePattern';
...
Srch.ValueInfo.Renderers.$5k = function Srch_ValueInfo_Renderers$$5k$st($p0) {
...
Srch.ValueInfo.ValueTypeHandler.$4E = function Srch_ValueInfo_ValueTypeHandler$$4E$st() {
...
Srch.ValueInfo.ValueTypeHandler.$3c = function Srch_ValueInfo_ValueTypeHandler$$3c$st($p0) {
    if (Srch.U.n($p0)) {
        return;
    }
...
Srch.ValueInfo.ValueTypeHandler.$15 = function Srch_ValueInfo_ValueTypeHandler$$15$st($p0, $p1, $p2) {
    var $v_0 = Srch.ValueInfo.ValueTypeHandler.$2W($p0, $p1);
    return Srch.U.getFieldOnObject($v_0, $p2);
}
Srch.ValueInfo.ValueTypeHandler.$2W = function Srch_ValueInfo_ValueTypeHandler$$2W$st($p0, $p1) {
    var $v_0 = Srch.ValueInfo.ValueTypeHandler.$4E();
    var $v_1 = Srch.ValueInfo.ValueTypeHandler.$2V(Srch.ValueInfo.ValueTypeHandler.$1e, $v_0, Srch.ValueInfo.ValueTypeHandler.$n);
    if (Srch.U.n($v_1)) {
    ...
    var $v_2 = null;
    if (!Srch.U.w($p0)) {
        $v_2 = Srch.ValueInfo.ValueTypeHandler.$2V($p0, $v_0, Srch.ValueInfo.ValueTypeHandler.$n);
        if (Srch.U.n($v_2)) {
            var $v_3 = Srch.ValueInfo.$g($p0);
            $v_2 = Srch.ValueInfo.ValueTypeHandler.$2V($v_3, $v_0, Srch.ValueInfo.ValueTypeHandler.$34);
        }
    }
    if (Srch.U.w($p1)) {
    ...
    if (Srch.U.n($v_2) && !Srch.U.w($p1)) {
        $v_2 = Srch.ValueInfo.ValueTypeHandler.$2V($p1, $v_0, Srch.ValueInfo.ValueTypeHandler.$2x);
    }
    return (Srch.U.n($v_2)) ? $v_1 : $v_2;
}
Srch.ValueInfo.ValueTypeHandler.$4A = function Srch_ValueInfo_ValueTypeHandler$$4A$st($p0) {
    var $v_0 = Srch.ValueInfo.ValueTypeHandler.$2W($p0, null);
    return (!Srch.U.n($v_0) && !Srch.U.w($v_0.refinementOverrideTemplateId)) ? $v_0.refinementOverrideTemplateId : '';
}
Srch.ValueInfo.ValueTypeHandler.$2V = function Srch_ValueInfo_ValueTypeHandler$$2V$st($p0, $p1, $p2) {
...
Srch.ValueInfo.ValueTypeHandler.$58 = function Srch_ValueInfo_ValueTypeHandler$$58$st($p0, $p1, $p2) {
    var $v_0 = Srch.ValueInfo.ValueTypeHandler.$2W($p1, $p2);
    var $v_1 = Srch.ValueInfo.ValueTypeHandler.$57($p0, $v_0);
    return $v_1;
}
Srch.ValueInfo.ValueTypeHandler.$57 = function Srch_ValueInfo_ValueTypeHandler$$57$st($p0, $p1) {
...
Srch.ValueInfo.ValueTypeHandler.$3b = function Srch_ValueInfo_ValueTypeHandler$$3b$st($p0, $p1, $p2) {
...
Srch.ValueInfo.ValueTypeHandler.$26 = function Srch_ValueInfo_ValueTypeHandler$$26$st($p0, $p1, $p2, $p3) {
    return Srch.ValueInfo.ValueTypeHandler.$4c($p0, $p1, $p2, null, $p3);
}
Srch.ValueInfo.ValueTypeHandler.$5T = function Srch_ValueInfo_ValueTypeHandler$$5T$st($p0) {
    if (Srch.U.w($p0)) {
        return '';
    }
    var $v_0 = {};
...
Srch.ValueInfo.ValueTypeHandler.$1N = function Srch_ValueInfo_ValueTypeHandler$$1N$st($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = [];
    return Srch.ValueInfo.ValueTypeHandler.$4c($p0, $p1, $p2, $p3, $p4);
}
Srch.ValueInfo.ValueTypeHandler.$4c = function Srch_ValueInfo_ValueTypeHandler$$4c$st($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = new Srch.ValueInfo.ValueTypeHandler();
    $v_0.id = $p0;
    $v_0.baseHandlerId = $p0;
    $v_0.matching[Srch.ValueInfo.ValueTypeHandler.$n] = $p1;
    $v_0.matching[Srch.ValueInfo.ValueTypeHandler.$34] = $p2;
    $v_0.matching[Srch.ValueInfo.ValueTypeHandler.$2x] = $p3;
    $v_0.valueRenderer = $p4;
    Srch.ValueInfo.ValueTypeHandler.$3c($v_0);
    return $v_0;
}
Srch.ValueInfo.ValueTypeHandler.get_$46 = function Srch_ValueInfo_ValueTypeHandler$get_$46$st() {
    var $v_0 = new Srch.ValueInfo.ValueTypeHandler();
    $v_0.id = Srch.ValueInfo.ValueTypeHandler.$1e;
    $v_0.baseHandlerId = Srch.ValueInfo.ValueTypeHandler.$1e;
    $v_0.matching[Srch.ValueInfo.ValueTypeHandler.$n] = [ Srch.ValueInfo.ValueTypeHandler.$1e ];
    return $v_0;
}
Srch.ValueInfo.ValueTypeHandler.get_$3D = function Srch_ValueInfo_ValueTypeHandler$get_$3D$st() {
    var $v_0 = {};
...
Srch.ValueInfo.ValueTypeHandler.$3I = function Srch_ValueInfo_ValueTypeHandler$$3I$st() {
    var $v_0 = {};
...
Srch.ValueInfo.ValueTypeHandler.$5W = function Srch_ValueInfo_ValueTypeHandler$$5W$st() {
    Srch.ValueInfo.ValueTypeHandler.$3c(Srch.ValueInfo.ValueTypeHandler.get_$46());
    var $v_0 = Srch.ValueInfo.ValueTypeHandler.$1N('NumericInt', [ 'UrlDepth', 'DocumentSummarySize', 'PictureHeight', 'PictureWidth', 'Rank', 'RecsClickedLifeTime', 'RecsClickedRecent', 'ReplyCount', 'siterank', 'SocialDistance', 'ViewsLifeTime', 'ViewsLifeTimeUniqueUsers', 'ViewsRecent', 'ViewsRecentUniqueUsers' ], [ 'OWSINTG', 'OWSRCNT' ], [ 'Integer' ], Srch.ValueInfo.Renderers.defaultNumberRenderer);
    $v_0.valueParser = Srch.ValueInfo.Parsers.$5j;
    $v_0.intervalLabels = Srch.ValueInfo.ValueTypeHandler.get_$3D();
    var $v_1 = Srch.ValueInfo.ValueTypeHandler.$1N('NumericFloat', [ 'Price', 'AAPrice' ], [ 'OWSNMBR', 'OWSCURR', 'OWSRAVG' ], [ 'Double', 'Decimal' ], Srch.ValueInfo.Renderers.defaultNumberRenderer);
    $v_1.valueParser = Srch.ValueInfo.Parsers.$5i;
    $v_1.intervalLabels = Srch.ValueInfo.ValueTypeHandler.get_$3D();
    var $v_2 = Srch.ValueInfo.ValueTypeHandler.$1N('EcmaDate', [ 'LastModifiedTime', 'Created', 'DiscoveredTime', 'DisplayDate', 'EndDate', 'ExpirationTimes', 'ExtractedDate', 'ImageDateCreated', 'processingtime', 'StartDate', 'StartDateInvariant', 'EndDateInvariant' ], [ 'OWSDATE' ], [ 'EcmaDate' ], Srch.ValueInfo.Renderers.defaultDateRenderer);
    $v_2.valueParser = Srch.ValueInfo.Parsers.$3C;
    $v_2.intervalLabels = Srch.ValueInfo.ValueTypeHandler.$3I();
    var $v_3 = Srch.ValueInfo.ValueTypeHandler.$1N('EcmaDateRefinersSingle', [ 'RefinableDateSingle00', 'RefinableDateSingle01', 'RefinableDateSingle02', 'RefinableDateSingle03', 'RefinableDateSingle04' ], [ 'OWSDATE' ], [ 'EcmaDate' ], Srch.ValueInfo.Renderers.defaultDateRenderer);
    $v_3.valueParser = Srch.ValueInfo.Parsers.$3C;
    $v_3.intervalLabels = Srch.ValueInfo.ValueTypeHandler.$3I();
    var $v_4 = Srch.ValueInfo.ValueTypeHandler.$1N('EcmaDateRefinersInvariant', [ 'RefinableDateInvariant00', 'RefinableDateInvariant01' ], [ 'OWSDATE' ], [ 'EcmaDate' ], Srch.ValueInfo.Renderers.defaultDateInvariantRenderer);
    $v_4.valueParser = Srch.ValueInfo.Parsers.$3C;
    $v_4.intervalLabels = Srch.ValueInfo.ValueTypeHandler.$3I();
    var $v_5 = Srch.ValueInfo.ValueTypeHandler.$26('ManagedMetadata', [ 'owstaxidmetadataalltagsinfo', 'owsmetadatafacetinfo', 'ows_MetadataFacetInfo', 'Tags' ], [ 'OWSTAXID' ], Srch.ValueInfo.Renderers.defaultRenderedValueHtmlEncoded);
    $v_5.valueParser = Srch.ValueInfo.Parsers.$63;
    $v_5.refinementSpecFilterDefault = 'L*';
    var $v_6 = Srch.ValueInfo.ValueTypeHandler.$26('User', [], [ 'OWSUSER' ], Srch.ValueInfo.Renderers.defaultRenderedValueHtmlEncoded);
    $v_6.valueParser = Srch.ValueInfo.Parsers.$67;
    var $v_7 = Srch.ValueInfo.ValueTypeHandler.$26('RichHtml', null, [ 'OWSLINK', 'OWSHTML' ], Srch.ValueInfo.Renderers.defaultRenderedValueNoHtmlEncoding);
    var $v_8 = Srch.ValueInfo.ValueTypeHandler.$26('ImageSrcUrl', [ 'PublishingImage' ], [ 'OWSIMGE' ], Srch.ValueInfo.Renderers.imageSourceRendering);
    var $v_9 = Srch.ValueInfo.ValueTypeHandler.$26('LinkHrefUrl', null, [ 'OWSURLH' ], Srch.ValueInfo.Renderers.defaultLinkHrefUrlRendering);
    $v_9.valueParser = Srch.ValueInfo.Parsers.$66;
    var $v_A = Srch.ValueInfo.ValueTypeHandler.$1N('Boolean', [ 'IsDocument', 'IsContainer', 'IsData', 'IsDefaultView', 'IsEmptyList', 'IsListItem', 'IsMyDocuments', 'IsPartiallyProcessed', 'IsReport', 'IsSharedWithGroup', 'NonDocument', 'RobotsNoIndex', 'SiteClosed', 'SiteContainer' ], [ 'OWSBOOL' ], [ 'YesNo' ], Srch.ValueInfo.Renderers.defaultBooleanRendering);
    $v_A.valueParser = Srch.ValueInfo.Parsers.$55;
...
Srch.ParseJSONUtil.$5y = function Srch_ParseJSONUtil$$5y$st($p0) {
...
Srch.ParseJSONUtil.parseObjectFromJsonString = function Srch_ParseJSONUtil$parseObjectFromJsonString$st(json) {
    ...
    json = Srch.ParseJSONUtil.$5y(json);
    var $v_1 = eval('(' + json + ')');
    return $v_1;
}
...
Srch.ClientControl.$1z = '<div class=\"ms-search-error\">{0}</div>';
Srch.DataProvider.$4U = 'D9BFB1A1-9036-4627-83B2-BBD9983AC8A1';
Srch.DataProvider.$2e = '4790B250-E2AF-4E4A-8136-600739EE3163';
Srch.DataProvider.$3V = '0BBA4D7D-4F2C-4086-975A-8F9D2B6C6D53';
Srch.DataProvider.$20 = '5DF7BA10-55D6-4da1-B55F-896F7BCB486B';
Srch.DataProvider.$3G = 'C8BDD081-7379-4c71-AAC8-61B6AA6E25A6';
Srch.DataProvider.$1n = '02B657FE-924F-4b2b-BB91-4A12BAF9929A';
...
Srch.U.$3A = 'ExecutionContext';
Srch.U.$1W = 'TemplateFunction';
Srch.U.$3B = 'Operation';
Srch.U.$2T = 'DisplayTemplateData';
...
Srch.ScriptApplicationManager.$1Z = null;
...
Srch.ValueInfo.ValueTypeHandler.$34 = 'TypeCode';
Srch.ValueInfo.ValueTypeHandler.$2x = 'SearchType';
Srch.ValueInfo.ValueTypeHandler.$1e = '*';
Srch.ValueInfo.ValueTypeHandler.$4L = [ Srch.ValueInfo.ValueTypeHandler.$n, Srch.ValueInfo.ValueTypeHandler.$34, Srch.ValueInfo.ValueTypeHandler.$2x ];
