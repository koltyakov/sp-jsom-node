...
PS.DraftAssignment.prototype = {
    ...
    get_costRateTable: function PS_DraftAssignment$get_costRateTable$in() {ULSyTi:;
        this.checkUninitializedProperty('CostRateTable');
        return (this.get_objectData().get_properties()['CostRateTable']);
    },
    
    set_costRateTable: function PS_DraftAssignment$set_costRateTable$in(value) {ULSyTi:;
    ...
    get_delay: function PS_DraftAssignment$get_delay$in() {ULSyTi:;
        this.checkUninitializedProperty('Delay');
        return (this.get_objectData().get_properties()['Delay']);
    },
    
    set_delay: function PS_DraftAssignment$set_delay$in(value) {ULSyTi:;
    ...
    get_delayMilliseconds: function PS_DraftAssignment$get_delayMilliseconds$in() {ULSyTi:;
        this.checkUninitializedProperty('DelayMilliseconds');
        return (this.get_objectData().get_properties()['DelayMilliseconds']);
    },
    
    set_delayMilliseconds: function PS_DraftAssignment$set_delayMilliseconds$in(value) {ULSyTi:;
    ...
    $K_2: function PS_DraftAssignment$$K_2$in($p0, $p1) {
        var $v_0 = this.get_context();
...
PS.DraftProjectResource.prototype = {
    ...
    $K_2: function PS_DraftProjectResource$$K_2$in($p0, $p1) {
        var $v_0 = this.get_context();
        this.get_fieldValues()[$p0] = $p1;
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'SetCustomFieldValue', [ $p0, $p1 ]);
        if ($v_0) {
...
PS.DraftTask.prototype = {
    ...
    $K_2: function PS_DraftTask$$K_2$in($p0, $p1) {
        var $v_0 = this.get_context();
        this.get_fieldValues()[$p0] = $p1;
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'SetCustomFieldValue', [ $p0, $p1 ]);
        if ($v_0) {
...
PS.Engagement.prototype = {
    ...
    get_comments: function PS_Engagement$get_comments$in() {ULSyTi:;
    ...
    get_createdDate: function PS_Engagement$get_createdDate$in() {ULSyTi:;
        this.checkUninitializedProperty('CreatedDate');
        return (this.get_objectData().get_properties()['CreatedDate']);
    },
    
    get_description: function PS_Engagement$get_description$in() {ULSyTi:;
        this.checkUninitializedProperty('Description');
        return (this.get_objectData().get_properties()['Description']);
    },
    
    set_description: function PS_Engagement$set_description$in(value) {ULSyTi:;
        this.get_objectData().get_properties()['Description'] = value;
        if (this.get_context()) {
            this.get_context().addQuery(new SP.ClientActionSetProperty(this, 'Description', value));
        }
    ...
    get_id: function PS_Engagement$get_id$in() {ULSyTi:;
        this.checkUninitializedProperty('Id');
        return (this.get_objectData().get_properties()['Id']);
    },
    
    get_modified: function PS_Engagement$get_modified$in() {ULSyTi:;
        this.checkUninitializedProperty('Modified');
        return (this.get_objectData().get_properties()['Modified']);
    },
    
    get_modifiedBy: function PS_Engagement$get_modifiedBy$in() {ULSyTi:;
    ...
    get_project: function PS_Engagement$get_project$in() {ULSyTi:;
    ...
    get_resource: function PS_Engagement$get_resource$in() {ULSyTi:;
        var $v_0 = ((this.get_objectData().get_clientObjectProperties()['Resource']));
        if (SP.ScriptUtility.isUndefined($v_0)) {
    ...
    set_resource: function PS_Engagement$set_resource$in(value) {ULSyTi:;
    ...
    get_reviewedBy: function PS_Engagement$get_reviewedBy$in() {ULSyTi:;
    ...
    get_submittedBy: function PS_Engagement$get_submittedBy$in() {ULSyTi:;
    ...
    get_submittedDate: function PS_Engagement$get_submittedDate$in() {ULSyTi:;
        this.checkUninitializedProperty('SubmittedDate');
        return (this.get_objectData().get_properties()['SubmittedDate']);
    },
    
    get_timephasedEditsOnly: function PS_Engagement$get_timephasedEditsOnly$in() {ULSyTi:;
        this.checkUninitializedProperty('TimephasedEditsOnly');
        return (this.get_objectData().get_properties()['TimephasedEditsOnly']);
    },
    
    initPropertiesFromJson: function PS_Engagement$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.ClientObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
...
PS.EngagementComment.prototype = {
    ...
    get_author: function PS_EngagementComment$get_author$in() {ULSyTi:;
    ...
    get_created: function PS_EngagementComment$get_created$in() {ULSyTi:;
        this.checkUninitializedProperty('Created');
        return (this.get_objectData().get_properties()['Created']);
    },
    
    get_id: function PS_EngagementComment$get_id$in() {ULSyTi:;
        this.checkUninitializedProperty('Id');
        return (this.get_objectData().get_properties()['Id']);
    },
    
    get_message: function PS_EngagementComment$get_message$in() {ULSyTi:;
        this.checkUninitializedProperty('Message');
        return (this.get_objectData().get_properties()['Message']);
    },
    
    initPropertiesFromJson: function PS_EngagementComment$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.ClientObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
...
PS.EngagementCommentCollection.prototype = {
    ...
    itemAt: function PS_EngagementCommentCollection$itemAt$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_item: function PS_EngagementCommentCollection$get_item$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function PS_EngagementCommentCollection$get_childItemType$in() {ULSyTi:;
        return PS.EngagementComment;
    },
    
    add: function PS_EngagementCommentCollection$add$in(comment) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
...
PS.EngagementCreationInformation.prototype = {
    ...
    get_description: function PS_EngagementCreationInformation$get_description$in() {ULSyTi:;
        return this.$2_1;
    },
    
    set_description: function PS_EngagementCreationInformation$set_description$in(value) {ULSyTi:;
        this.$2_1 = value;
        return value;
    },
    
    get_finish: function PS_EngagementCreationInformation$get_finish$in() {ULSyTi:;
        return this.$5_1;
    },
    
    set_finish: function PS_EngagementCreationInformation$set_finish$in(value) {ULSyTi:;
        this.$5_1 = value;
        return value;
    },
    
    get_id: function PS_EngagementCreationInformation$get_id$in() {ULSyTi:;
        return this.$0_1;
    },
    
    set_id: function PS_EngagementCreationInformation$set_id$in(value) {ULSyTi:;
        this.$0_1 = value;
        return value;
    },
    
    get_maxUnits: function PS_EngagementCreationInformation$get_maxUnits$in() {ULSyTi:;
        return this.$E_1;
    },
    
    set_maxUnits: function PS_EngagementCreationInformation$set_maxUnits$in(value) {ULSyTi:;
        this.$E_1 = value;
        return value;
    },
    
    get_start: function PS_EngagementCreationInformation$get_start$in() {ULSyTi:;
        return this.$3_1;
    },
    
    set_start: function PS_EngagementCreationInformation$set_start$in(value) {ULSyTi:;
        this.$3_1 = value;
        return value;
    },
    
    get_timephasedPeriodData: function PS_EngagementCreationInformation$get_timephasedPeriodData$in() {ULSyTi:;
        return this.$Q_1;
    },
    
    set_timephasedPeriodData: function PS_EngagementCreationInformation$set_timephasedPeriodData$in(value) {ULSyTi:;
        this.$Q_1 = value;
        return value;
    },
    
    get_work: function PS_EngagementCreationInformation$get_work$in() {ULSyTi:;
        return this.$A_1;
    },
    
    set_work: function PS_EngagementCreationInformation$set_work$in(value) {ULSyTi:;
        this.$A_1 = value;
        return value;
    },
    
    get_workMilliseconds: function PS_EngagementCreationInformation$get_workMilliseconds$in() {ULSyTi:;
        return this.$J_1;
    },
    
    set_workMilliseconds: function PS_EngagementCreationInformation$set_workMilliseconds$in(value) {ULSyTi:;
        this.$J_1 = value;
        return value;
    },
    
    get_typeId: function PS_EngagementCreationInformation$get_typeId$in() {ULSyTi:;
        return '{52253f4e-712f-40c2-a9a3-a4f429affdf0}';
    },
    
    writeToXml: function PS_EngagementCreationInformation$writeToXml$in(writer, serializationContext) {ULSyTi:;
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function PS_EngagementCreationInformation$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.Description;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
PS.EngagementSaveConflictException.prototype = {
    ...
    get_typeId: function PS_EngagementSaveConflictException$get_typeId$in() {ULSyTi:;
        return '{33d7a6a8-1b61-42ea-92b7-33f5c069d7c0}';
    },
    
    writeToXml: function PS_EngagementSaveConflictException$writeToXml$in(writer, serializationContext) {ULSyTi:;
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
...
PS.EngagementTimephasedPeriod.prototype = {
    ...
    get_end: function PS_EngagementTimephasedPeriod$get_end$in() {ULSyTi:;
        this.checkUninitializedProperty('End');
        return (this.get_objectData().get_properties()['End']);
    },
    
    get_maxUnits: function PS_EngagementTimephasedPeriod$get_maxUnits$in() {ULSyTi:;
        this.checkUninitializedProperty('MaxUnits');
        return (this.get_objectData().get_properties()['MaxUnits']);
    },
    
    set_maxUnits: function PS_EngagementTimephasedPeriod$set_maxUnits$in(value) {ULSyTi:;
    ...
    get_start: function PS_EngagementTimephasedPeriod$get_start$in() {ULSyTi:;
        this.checkUninitializedProperty('Start');
        return (this.get_objectData().get_properties()['Start']);
    },
    
    get_work: function PS_EngagementTimephasedPeriod$get_work$in() {ULSyTi:;
        this.checkUninitializedProperty('Work');
        return (this.get_objectData().get_properties()['Work']);
    },
    
    set_work: function PS_EngagementTimephasedPeriod$set_work$in(value) {ULSyTi:;
        this.get_objectData().get_properties()['Work'] = value;
        if (this.get_context()) {
            this.get_context().addQuery(new SP.ClientActionSetProperty(this, 'Work', value));
        }
    ...
    get_workMilliseconds: function PS_EngagementTimephasedPeriod$get_workMilliseconds$in() {ULSyTi:;
        this.checkUninitializedProperty('WorkMilliseconds');
        return (this.get_objectData().get_properties()['WorkMilliseconds']);
    },
    
    set_workMilliseconds: function PS_EngagementTimephasedPeriod$set_workMilliseconds$in(value) {ULSyTi:;
        this.get_objectData().get_properties()['WorkMilliseconds'] = value;
        if (this.get_context()) {
            this.get_context().addQuery(new SP.ClientActionSetProperty(this, 'WorkMilliseconds', value));
        }
    ...
    initPropertiesFromJson: function PS_EngagementTimephasedPeriod$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.ClientObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.End;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
PS.EngagementTimephasedPeriodCreationInformation.prototype = {
    ...
    get_end: function PS_EngagementTimephasedPeriodCreationInformation$get_end$in() {ULSyTi:;
        return this.$D_1;
    },
    
    set_end: function PS_EngagementTimephasedPeriodCreationInformation$set_end$in(value) {ULSyTi:;
        this.$D_1 = value;
        return value;
    },
    
    get_maxUnits: function PS_EngagementTimephasedPeriodCreationInformation$get_maxUnits$in() {ULSyTi:;
        return this.$E_1;
    },
    
    set_maxUnits: function PS_EngagementTimephasedPeriodCreationInformation$set_maxUnits$in(value) {ULSyTi:;
        this.$E_1 = value;
        return value;
    },
    
    get_start: function PS_EngagementTimephasedPeriodCreationInformation$get_start$in() {ULSyTi:;
        return this.$3_1;
    },
    
    set_start: function PS_EngagementTimephasedPeriodCreationInformation$set_start$in(value) {ULSyTi:;
        this.$3_1 = value;
        return value;
    },
    
    get_work: function PS_EngagementTimephasedPeriodCreationInformation$get_work$in() {ULSyTi:;
        return this.$A_1;
    },
    
    set_work: function PS_EngagementTimephasedPeriodCreationInformation$set_work$in(value) {ULSyTi:;
        this.$A_1 = value;
        return value;
    },
    
    get_workMilliseconds: function PS_EngagementTimephasedPeriodCreationInformation$get_workMilliseconds$in() {ULSyTi:;
        return this.$J_1;
    },
    
    set_workMilliseconds: function PS_EngagementTimephasedPeriodCreationInformation$set_workMilliseconds$in(value) {ULSyTi:;
        this.$J_1 = value;
        return value;
    },
    
    get_typeId: function PS_EngagementTimephasedPeriodCreationInformation$get_typeId$in() {ULSyTi:;
        return '{af0665d0-6c93-4a50-bbaa-0e970a188754}';
    },
    
    writeToXml: function PS_EngagementTimephasedPeriodCreationInformation$writeToXml$in(writer, serializationContext) {ULSyTi:;
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function PS_EngagementTimephasedPeriodCreationInformation$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.ClientValueObject.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.End;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
...
PS.EnterpriseProjectType.prototype = {
    ...
    get_permissionSyncEnable: function PS_EnterpriseProjectType$get_permissionSyncEnable$in() {ULSyTi:;
        this.checkUninitializedProperty('PermissionSyncEnable');
        return (this.get_objectData().get_properties()['PermissionSyncEnable']);
    },
    
    set_permissionSyncEnable: function PS_EnterpriseProjectType$set_permissionSyncEnable$in(value) {ULSyTi:;
    ...
    get_siteCreationOption: function PS_EnterpriseProjectType$get_siteCreationOption$in() {ULSyTi:;
        this.checkUninitializedProperty('SiteCreationOption');
        return (this.get_objectData().get_properties()['SiteCreationOption']);
    },
    
    set_siteCreationOption: function PS_EnterpriseProjectType$set_siteCreationOption$in(value) {ULSyTi:;
    ...
    get_siteCreationURL: function PS_EnterpriseProjectType$get_siteCreationURL$in() {ULSyTi:;
        this.checkUninitializedProperty('SiteCreationURL');
        return (this.get_objectData().get_properties()['SiteCreationURL']);
    },
    
    set_siteCreationURL: function PS_EnterpriseProjectType$set_siteCreationURL$in(value) {ULSyTi:;
    ...
    get_taskListSyncEnable: function PS_EnterpriseProjectType$get_taskListSyncEnable$in() {ULSyTi:;
        this.checkUninitializedProperty('TaskListSyncEnable');
        return (this.get_objectData().get_properties()['TaskListSyncEnable']);
    },
    
    set_taskListSyncEnable: function PS_EnterpriseProjectType$set_taskListSyncEnable$in(value) {ULSyTi:;
    ...
    get_workspaceTemplateLCID: function PS_EnterpriseProjectType$get_workspaceTemplateLCID$in() {ULSyTi:;
        this.checkUninitializedProperty('WorkspaceTemplateLCID');
        return (this.get_objectData().get_properties()['WorkspaceTemplateLCID']);
    },
    
    set_workspaceTemplateLCID: function PS_EnterpriseProjectType$set_workspaceTemplateLCID$in(value) {ULSyTi:;
...
PS.EnterpriseProjectTypeCreationInformation.prototype = {
    ...
    get_permissionSyncEnable: function PS_EnterpriseProjectTypeCreationInformation$get_permissionSyncEnable$in() {ULSyTi:;
        return this.$1D_1;
    },
    
    set_permissionSyncEnable: function PS_EnterpriseProjectTypeCreationInformation$set_permissionSyncEnable$in(value) {ULSyTi:;
        this.$1D_1 = value;
        return value;
    },
    ...
    get_siteCreationOption: function PS_EnterpriseProjectTypeCreationInformation$get_siteCreationOption$in() {ULSyTi:;
        return this.$1c_1;
    },
    
    set_siteCreationOption: function PS_EnterpriseProjectTypeCreationInformation$set_siteCreationOption$in(value) {ULSyTi:;
        this.$1c_1 = value;
        return value;
    },
    
    get_siteCreationURL: function PS_EnterpriseProjectTypeCreationInformation$get_siteCreationURL$in() {ULSyTi:;
        return this.$1d_1;
    },
    
    set_siteCreationURL: function PS_EnterpriseProjectTypeCreationInformation$set_siteCreationURL$in(value) {ULSyTi:;
        this.$1d_1 = value;
        return value;
    },
    
    get_taskListSyncEnable: function PS_EnterpriseProjectTypeCreationInformation$get_taskListSyncEnable$in() {ULSyTi:;
        return this.$1l_1;
    },
    
    set_taskListSyncEnable: function PS_EnterpriseProjectTypeCreationInformation$set_taskListSyncEnable$in(value) {ULSyTi:;
        this.$1l_1 = value;
        return value;
    },
    ...
    get_workspaceTemplateLCID: function PS_EnterpriseProjectTypeCreationInformation$get_workspaceTemplateLCID$in() {ULSyTi:;
        return this.$1s_1;
    },
    
    set_workspaceTemplateLCID: function PS_EnterpriseProjectTypeCreationInformation$set_workspaceTemplateLCID$in(value) {ULSyTi:;
        this.$1s_1 = value;
        return value;
    },
...
PS.EnterpriseResource.prototype = {
    ...
    get_engagements: function PS_EnterpriseResource$get_engagements$in() {ULSyTi:;
    ...
    get_requiresEngagements: function PS_EnterpriseResource$get_requiresEngagements$in() {ULSyTi:;
        this.checkUninitializedProperty('RequiresEngagements');
        return (this.get_objectData().get_properties()['RequiresEngagements']);
    },
    
    set_requiresEngagements: function PS_EnterpriseResource$set_requiresEngagements$in(value) {ULSyTi:;
    ...
    $K_1: function PS_EnterpriseResource$$K_1$in($p0, $p1) {
        var $v_0 = this.get_context();
        this.get_fieldValues()[$p0] = $p1;
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'SetCustomFieldValue', [ $p0, $p1 ]);
        if ($v_0) {
...
PS.PageSizes.newObject = function PS_PageSizes$newObject$st(context, server) {ULSyTi:;
...
PS.PlanAssignment.prototype = {
    ...
    $K_1: function PS_PlanAssignment$$K_1$in($p0, $p1) {
        var $v_0 = this.get_context();
        this.get_fieldValues()[$p0] = $p1;
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'SetCustomFieldValue', [ $p0, $p1 ]);
        if ($v_0) {
...
PS.Project.prototype = {
    ...
    get_engagements: function PS_Project$get_engagements$in() {ULSyTi:;
        var $v_0 = ((this.get_objectData().get_clientObjectProperties()['Engagements']));
        if (SP.ScriptUtility.isUndefined($v_0)) {
...
PS.ProjectEngagement.prototype = {
    ...
    get_approvedFinish: function PS_ProjectEngagement$get_approvedFinish$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedFinish');
        return (this.get_objectData().get_properties()['ApprovedFinish']);
    },
    
    get_approvedMaxUnits: function PS_ProjectEngagement$get_approvedMaxUnits$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedMaxUnits');
        return (this.get_objectData().get_properties()['ApprovedMaxUnits']);
    },
    
    get_approvedStart: function PS_ProjectEngagement$get_approvedStart$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedStart');
        return (this.get_objectData().get_properties()['ApprovedStart']);
    },
    
    get_approvedWork: function PS_ProjectEngagement$get_approvedWork$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedWork');
        return (this.get_objectData().get_properties()['ApprovedWork']);
    },
    
    get_approvedWorkMilliseconds: function PS_ProjectEngagement$get_approvedWorkMilliseconds$in() {ULSyTi:;
    ...
    get_hasUnsubmittedChanges: function PS_ProjectEngagement$get_hasUnsubmittedChanges$in() {ULSyTi:;
        this.checkUninitializedProperty('HasUnsubmittedChanges');
        return (this.get_objectData().get_properties()['HasUnsubmittedChanges']);
    },
    
    get_requestedFinish: function PS_ProjectEngagement$get_requestedFinish$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedFinish');
        return (this.get_objectData().get_properties()['RequestedFinish']);
    },
    
    set_requestedFinish: function PS_ProjectEngagement$set_requestedFinish$in(value) {ULSyTi:;
    ...
    get_requestedMaxUnits: function PS_ProjectEngagement$get_requestedMaxUnits$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedMaxUnits');
        return (this.get_objectData().get_properties()['RequestedMaxUnits']);
    },
    
    set_requestedMaxUnits: function PS_ProjectEngagement$set_requestedMaxUnits$in(value) {ULSyTi:;
    ...
    get_requestedStart: function PS_ProjectEngagement$get_requestedStart$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedStart');
        return (this.get_objectData().get_properties()['RequestedStart']);
    },
    
    set_requestedStart: function PS_ProjectEngagement$set_requestedStart$in(value) {ULSyTi:;
    ...
    get_requestedWork: function PS_ProjectEngagement$get_requestedWork$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedWork');
        return (this.get_objectData().get_properties()['RequestedWork']);
    },
    
    set_requestedWork: function PS_ProjectEngagement$set_requestedWork$in(value) {ULSyTi:;
    ...
    get_requestedWorkMilliseconds: function PS_ProjectEngagement$get_requestedWorkMilliseconds$in() {ULSyTi:;
    ...
    set_requestedWorkMilliseconds: function PS_ProjectEngagement$set_requestedWorkMilliseconds$in(value) {ULSyTi:;
    ...
    initPropertiesFromJson: function PS_ProjectEngagement$initPropertiesFromJson$in(parentNode) {ULSyTi:;
    ...
    deleteObject: function PS_ProjectEngagement$deleteObject$in() {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'DeleteObject', null);
        $v_0.addQuery($v_1);
    },
    
    getTimephased: function PS_ProjectEngagement$getTimephased$in(start, end, timescale, contourType) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
...
PS.ProjectEngagementCollection.prototype = {
    ...
    itemAt: function PS_ProjectEngagementCollection$itemAt$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_item: function PS_ProjectEngagementCollection$get_item$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function PS_ProjectEngagementCollection$get_childItemType$in() {ULSyTi:;
        return PS.ProjectEngagement;
    },
    
    add: function PS_ProjectEngagementCollection$add$in(parameters) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
    ...
    remove: function PS_ProjectEngagementCollection$remove$in(engagement) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
    ...
    update: function PS_ProjectEngagementCollection$update$in() {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'Update', null);
        $v_0.addQuery($v_1);
    },
    
    getById: function PS_ProjectEngagementCollection$getById$in(objectId) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = ((this.get_objectData().get_methodReturnObjects()['GetById']));
        if (SP.ScriptUtility.isNullOrUndefined($v_2)) {
    ...
    getByGuid: function PS_ProjectEngagementCollection$getByGuid$in(uid) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = ((this.get_objectData().get_methodReturnObjects()['GetByGuid']));
        if (SP.ScriptUtility.isNullOrUndefined($v_2)) {
...
PS.ProjectEngagementCreationInformation.prototype = {
    ...
    get_resource: function PS_ProjectEngagementCreationInformation$get_resource$in() {ULSyTi:;
        return this.$1z_2;
    },
    
    set_resource: function PS_ProjectEngagementCreationInformation$set_resource$in(value) {ULSyTi:;
        this.$1z_2 = value;
        return value;
    },
    
    get_typeId: function PS_ProjectEngagementCreationInformation$get_typeId$in() {ULSyTi:;
        return '{f16468f3-36d1-4840-9ead-b271168a7870}';
    },
    
    writeToXml: function PS_ProjectEngagementCreationInformation$writeToXml$in(writer, serializationContext) {ULSyTi:;
        if (!writer) {
            throw Error.argumentNull('writer');
        }
        if (!serializationContext) {
    ...
    initPropertiesFromJson: function PS_ProjectEngagementCreationInformation$initPropertiesFromJson$in(parentNode) {ULSyTi:;
...
PS.ProjectEngagementTimephasedCollection.prototype = {
    ...
    itemAt: function PS_ProjectEngagementTimephasedCollection$itemAt$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_item: function PS_ProjectEngagementTimephasedCollection$get_item$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function PS_ProjectEngagementTimephasedCollection$get_childItemType$in() {ULSyTi:;
        return PS.ProjectEngagementTimephasedPeriod;
    },
    
    getByStart: function PS_ProjectEngagementTimephasedCollection$getByStart$in(date) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
...
PS.ProjectServer.prototype = {
    ...
    get_engagementsTimephasedPageSize: function PS_ProjectServer$get_engagementsTimephasedPageSize$in() {ULSyTi:;
    ...
    get_enterpriseResourcesPageSize: function PS_ProjectServer$get_enterpriseResourcesPageSize$in() {ULSyTi:;
    ...
    get_projectsPageSize: function PS_ProjectServer$get_projectsPageSize$in() {ULSyTi:;
...
PS.PublishedAssignment.prototype = {
    ...
    get_costRateTable: function PS_PublishedAssignment$get_costRateTable$in() {ULSyTi:;
        this.checkUninitializedProperty('CostRateTable');
        return (this.get_objectData().get_properties()['CostRateTable']);
    },
    ...
    get_delay: function PS_PublishedAssignment$get_delay$in() {ULSyTi:;
        this.checkUninitializedProperty('Delay');
        return (this.get_objectData().get_properties()['Delay']);
    },
    
    get_delayMilliseconds: function PS_PublishedAssignment$get_delayMilliseconds$in() {ULSyTi:;
        this.checkUninitializedProperty('DelayMilliseconds');
        return (this.get_objectData().get_properties()['DelayMilliseconds']);
    },
...
PS.ResourceEngagement.prototype = {
    ...
    get_approvedFinish: function PS_ResourceEngagement$get_approvedFinish$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedFinish');
        return (this.get_objectData().get_properties()['ApprovedFinish']);
    },
    
    set_approvedFinish: function PS_ResourceEngagement$set_approvedFinish$in(value) {ULSyTi:;
    ...
    get_approvedMaxUnits: function PS_ResourceEngagement$get_approvedMaxUnits$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedMaxUnits');
        return (this.get_objectData().get_properties()['ApprovedMaxUnits']);
    },
    
    set_approvedMaxUnits: function PS_ResourceEngagement$set_approvedMaxUnits$in(value) {ULSyTi:;
    ...
    get_approvedStart: function PS_ResourceEngagement$get_approvedStart$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedStart');
        return (this.get_objectData().get_properties()['ApprovedStart']);
    },
    
    set_approvedStart: function PS_ResourceEngagement$set_approvedStart$in(value) {ULSyTi:;
    ...
    get_approvedWork: function PS_ResourceEngagement$get_approvedWork$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedWork');
        return (this.get_objectData().get_properties()['ApprovedWork']);
    },
    
    set_approvedWork: function PS_ResourceEngagement$set_approvedWork$in(value) {ULSyTi:;
    ...
    get_approvedWorkMilliseconds: function PS_ResourceEngagement$get_approvedWorkMilliseconds$in() {ULSyTi:;
        this.checkUninitializedProperty('ApprovedWorkMilliseconds');
        return (this.get_objectData().get_properties()['ApprovedWorkMilliseconds']);
    },
    
    set_approvedWorkMilliseconds: function PS_ResourceEngagement$set_approvedWorkMilliseconds$in(value) {ULSyTi:;
    ...
    get_requestedFinish: function PS_ResourceEngagement$get_requestedFinish$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedFinish');
        return (this.get_objectData().get_properties()['RequestedFinish']);
    },
    
    get_requestedMaxUnits: function PS_ResourceEngagement$get_requestedMaxUnits$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedMaxUnits');
        return (this.get_objectData().get_properties()['RequestedMaxUnits']);
    },
    
    get_requestedStart: function PS_ResourceEngagement$get_requestedStart$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedStart');
        return (this.get_objectData().get_properties()['RequestedStart']);
    },
    
    get_requestedWork: function PS_ResourceEngagement$get_requestedWork$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedWork');
        return (this.get_objectData().get_properties()['RequestedWork']);
    },
    
    get_requestedWorkMilliseconds: function PS_ResourceEngagement$get_requestedWorkMilliseconds$in() {ULSyTi:;
        this.checkUninitializedProperty('RequestedWorkMilliseconds');
        return (this.get_objectData().get_properties()['RequestedWorkMilliseconds']);
    },
    
    initPropertiesFromJson: function PS_ResourceEngagement$initPropertiesFromJson$in(parentNode) {ULSyTi:;
        PS.Engagement.prototype.initPropertiesFromJson.call(this, parentNode);
        var $v_0;
        $v_0 = parentNode.ApprovedFinish;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
    ...
    deleteObject: function PS_ResourceEngagement$deleteObject$in() {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'DeleteObject', null);
        $v_0.addQuery($v_1);
    },
    
    getTimephased: function PS_ResourceEngagement$getTimephased$in(start, end, timescale, contourType) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
...
PS.ResourceEngagementCollection.prototype = {
    ...
    itemAt: function PS_ResourceEngagementCollection$itemAt$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_item: function PS_ResourceEngagementCollection$get_item$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function PS_ResourceEngagementCollection$get_childItemType$in() {ULSyTi:;
        return PS.ResourceEngagement;
    },
    
    remove: function PS_ResourceEngagementCollection$remove$in(engagement) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'Remove', [ engagement ]);
        $v_0.addQuery($v_2);
    ...
    update: function PS_ResourceEngagementCollection$update$in() {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'Update', null);
        $v_0.addQuery($v_1);
    },
    
    getById: function PS_ResourceEngagementCollection$getById$in(objectId) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = ((this.get_objectData().get_methodReturnObjects()['GetById']));
        if (SP.ScriptUtility.isNullOrUndefined($v_2)) {
    ...
    getByGuid: function PS_ResourceEngagementCollection$getByGuid$in(uid) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = ((this.get_objectData().get_methodReturnObjects()['GetByGuid']));
        if (SP.ScriptUtility.isNullOrUndefined($v_2)) {
...
PS.ResourceEngagementTimephasedCollection.prototype = {
    ...
    itemAt: function PS_ResourceEngagementTimephasedCollection$itemAt$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_item: function PS_ResourceEngagementTimephasedCollection$get_item$in(index) {ULSyTi:;
        return this.getItemAtIndex(index);
    },
    
    get_childItemType: function PS_ResourceEngagementTimephasedCollection$get_childItemType$in() {ULSyTi:;
        return PS.ResourceEngagementTimephasedPeriod;
    },
    
    getByStart: function PS_ResourceEngagementTimephasedCollection$getByStart$in(date) {ULSyTi:;
        var $v_0 = this.get_context();
        var $v_1;
...
PS.StatusAssignment.prototype = {
    ...
    $K_1: function PS_StatusAssignment$$K_1$in($p0, $p1) {
        var $v_0 = this.get_context();
        this.get_fieldValues()[$p0] = $p1;
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'SetCustomFieldValue', [ $p0, $p1 ]);
        if ($v_0) {
...
PS.StatusTask.prototype = {
    ...
    get_fieldValues: function PS_StatusTask$get_fieldValues$in() {ULSyTi:;
        var $v_0 = this.get_objectData().get_methodReturnObjects()['$m_dict'];
        if (SP.ScriptUtility.isNullOrUndefined($v_0)) {
            $v_0 = {};
            this.get_objectData().get_methodReturnObjects()['$m_dict'] = $v_0;
    ...
    get_item: function PS_StatusTask$get_item$in(fieldName) {ULSyTi:;
        return this.$6_1(fieldName);
    },
    ...
    get_customFields: function PS_StatusTask$get_customFields$in() {ULSyTi:;
        var $v_0 = ((this.get_objectData().get_clientObjectProperties()['CustomFields']));
        if (SP.ScriptUtility.isUndefined($v_0)) {
            $v_0 = new PS.CustomFieldCollection(this.get_context(), new SP.ObjectPathProperty(this.get_context(), this.get_path(), 'CustomFields'));
            this.get_objectData().get_clientObjectProperties()['CustomFields'] = $v_0;
    ...
    initNonPropertiesFromJson: function PS_StatusTask$initNonPropertiesFromJson$in(parentNode) {ULSyTi:;
        SP.DataConvert.populateDictionaryFromObject(this.get_fieldValues(), parentNode);
        SP.DataConvert.fixupTypes(this.get_context(), this.get_fieldValues());
    },
    ...
    $6_1: function PS_StatusTask$$6_1$in($p0) {
        var $v_0 = this.get_fieldValues()[$p0];
        if (SP.ScriptUtility.isUndefined($v_0)) {
            throw Error.create(SP.ResResources.getString('PropertyHasNotBeenInitialized'));
        }
    ...
    refreshLoad: function PS_StatusTask$refreshLoad$in() {ULSyTi:;
        SP.ClientObject.prototype.refreshLoad.call(this);
        this.loadExpandoFields();
    },
    
    loadExpandoFields: function PS_StatusTask$loadExpandoFields$in() {ULSyTi:;
        var $$dict_1 = this.get_fieldValues();
        for (var $$key_2 in $$dict_1) {
            var $v_0 = { key: $$key_2, value: $$dict_1[$$key_2] };
            this.retrieve($v_0.key);
